...
class OfferDisputeRead(BaseModel):
    ...
    organization: Optional[OfferDisputeReadOrganization] = None
    seller: PersonaDisputeRead = Field(description="If the seller is actually YOUR organization, set it to NULL.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organization": OfferDisputeReadOrganization.from_dict(obj["organization"]) if obj.get("organization") is not None else None,
            "seller": PersonaDisputeRead.from_dict(obj["seller"]) if obj.get("seller") is not None else None,
            ...
            "medias": [MediaDisputeRead.from_dict(_item) for _item in obj["medias"]] if obj.get("medias") is not None else None
        })
        return _obj
