...
class OfferIndependentWrite(BaseModel):
    ...
    seller: OfferPersonaIndependentWrite = Field(description="If the seller is actually YOUR organization, set it to NULL.")
    ...
    __properties: ClassVar[List[str]] = ["redirectUrl", "seller", "nature", "title", "description", "unitPrice", "currencyCode", "itemCount", "condition", "weightInGram", "shippingAllowed", "handDeliveryAllowed", "shippingCarriers", "eanCode", "canBeSoldSeparately", "metadata"]
