...
class OfferRead(BaseModel):
    ...
    medias: conlist(MediaRead) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OfferRead:
    ...
    def from_dict(cls, obj: dict) -> OfferRead:
        ...
        _obj = OfferRead.parse_obj({
            ...
            "organization": OfferReadOrganization.from_dict(obj.get("organization")) if obj.get("organization") is not None else None,
