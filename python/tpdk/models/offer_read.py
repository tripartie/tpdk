...
class OfferRead(BaseModel):
    ...
    organization: Optional[OfferReadOrganization] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organization": OfferReadOrganization.from_dict(obj["organization"]) if obj.get("organization") is not None else None,
            "seller": PersonaRead.from_dict(obj["seller"]) if obj.get("seller") is not None else None,
            ...
            "medias": [MediaRead.from_dict(_item) for _item in obj["medias"]] if obj.get("medias") is not None else None
        })
        return _obj
