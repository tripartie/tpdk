...
class TransactionIndependentWrite(BaseModel):
    ...
    parcels: Optional[List[ParcelIndependentWrite]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "offer": OfferIndependentWrite.from_dict(obj["offer"]) if obj.get("offer") is not None else None,
            "buyer": PersonaIndependentWrite.from_dict(obj["buyer"]) if obj.get("buyer") is not None else None,
            "fees": obj.get("fees"),
            "refundableFees": obj.get("refundableFees"),
            "metadata": [MetadataIndependentWrite.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None,
            "parcels": [ParcelIndependentWrite.from_dict(_item) for _item in obj["parcels"]] if obj.get("parcels") is not None else None
        })
        return _obj
