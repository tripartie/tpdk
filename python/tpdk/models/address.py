...
class Address(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "companyName", "countryCode", "zipCode", "cityName", "firstLine", "secondLine", "buildingName", "buildingFloor", "gateOrPortalOrInboxCode", "createdAt", "updatedAt"]
