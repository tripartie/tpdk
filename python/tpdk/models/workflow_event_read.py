...
class WorkflowEventRead(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkflowEventRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkflowEventRead:
        """Create an instance of WorkflowEventRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkflowEventRead.parse_obj(obj)

        _obj = WorkflowEventRead.parse_obj({
            "label": obj.get("label"),
