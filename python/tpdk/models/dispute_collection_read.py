...
class DisputeCollectionRead(BaseModel):
    ...
    """ # noqa: E501
    ulid: StrictStr
    transaction: Optional[DisputeTransactionCollectionRead] = None
    status: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ulid": obj.get("ulid"),
            "transaction": DisputeTransactionCollectionRead.from_dict(obj["transaction"]) if obj.get("transaction") is not None else None,
