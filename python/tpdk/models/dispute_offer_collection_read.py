...
class DisputeOfferCollectionRead(BaseModel):
    """
    ...
    seller: DisputePersonaCollectionRead = Field(description="If the seller is actually YOUR organization, set it to NULL.")
    ...
    __properties: ClassVar[List[str]] = ["ulid", "publicUrl", "seller", "title", "unitPrice", "currencyCode", "itemCount", "condition"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seller": DisputePersonaCollectionRead.from_dict(obj["seller"]) if obj.get("seller") is not None else None,
            "title": obj.get("title"),
