...
class UserTotpToggleWrite(BaseModel):
    """
    
    """ # noqa: E501
    totp_enabled: StrictBool = Field(alias="totpEnabled")
    totp_challenge: Optional[StrictStr] = Field(alias="totpChallenge")
    __properties: ClassVar[List[str]] = ["totpEnabled", "totpChallenge"]
