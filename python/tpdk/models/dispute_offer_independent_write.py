...
class DisputeOfferIndependentWrite(BaseModel):
    """
    ...
    seller: DisputePersonaIndependentWrite = Field(description="If the seller is actually YOUR organization, set it to NULL.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seller": DisputePersonaIndependentWrite.from_dict(obj["seller"]) if obj.get("seller") is not None else None,
