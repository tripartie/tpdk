...
class OfferCollectionRead(BaseModel):
    ...
    seller: PersonaCollectionRead = Field(description="If the seller is actually YOUR organization, set it to NULL.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seller": PersonaCollectionRead.from_dict(obj["seller"]) if obj.get("seller") is not None else None,
            "title": obj.get("title"),
