...
class UserWrite(BaseModel):
    ...
    organization: Optional[UserOrganizationWrite] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organization": UserOrganizationWrite.from_dict(obj["organization"]) if obj.get("organization") is not None else None
        })
        return _obj
