...
class Offer(BaseModel):
    ...
    half_price_point: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="halfPricePoint")
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.half_price_point is None and "half_price_point" in self.__fields_set__:
    ...
    def from_dict(cls, obj: dict) -> Offer:
        ...
        _obj = Offer.parse_obj({
            ...
            "iri": obj.get("iri"),
            "half_price_point": obj.get("halfPricePoint")
        })
        return _obj
