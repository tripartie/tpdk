...
class OrganizationUserRead(BaseModel):
    ...
    icon: Optional[OrganizationUserReadIcon] = None
    logo: Optional[OrganizationUserReadIcon] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icon": OrganizationUserReadIcon.from_dict(obj["icon"]) if obj.get("icon") is not None else None,
            "logo": OrganizationUserReadIcon.from_dict(obj["logo"]) if obj.get("logo") is not None else None,
