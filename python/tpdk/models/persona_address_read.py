...
class PersonaAddressRead(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["companyName", "countryCode", "zipCode", "cityName", "firstLine", "secondLine", "buildingName", "buildingFloor", "gateOrPortalOrInboxCode", "createdAt", "updatedAt"]
