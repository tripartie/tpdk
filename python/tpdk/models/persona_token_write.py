...
class PersonaTokenWrite(BaseModel):
    ...
    """ # noqa: E501
    target_url: Optional[StrictStr] = Field(description="The URL you wish that Persona to go to without additional MFA. The URL MUST concern that Persona.", alias="targetUrl")
    __properties: ClassVar[List[str]] = ["targetUrl"]
