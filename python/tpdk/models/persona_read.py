...
class PersonaRead(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "firstName", "lastName", "gender", "dateOfBirth", "language", "email", "mobilePhoneNumber", "address", "riskLevel", "riskScore", "externalPurchaseCount", "externalSellCount", "metadata", "createdAt", "updatedAt", "offerCount", "purchaseCount"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "address": AddressRead.from_dict(obj.get("address")) if obj.get("address") is not None else None,
