...
class UserCollectionRead(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "avatar": OrganizationCollectionReadIcon.from_dict(obj["avatar"]) if obj.get("avatar") is not None else None,
            "createdAt": obj.get("createdAt"),
            "updatedAt": obj.get("updatedAt"),
            "organization": UserCollectionReadOrganization.from_dict(obj["organization"]) if obj.get("organization") is not None else None,
            "iri": obj.get("iri"),
            "2fa": obj.get("2fa")
        })
        return _obj
