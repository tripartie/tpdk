...
class UserCollectionRead(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "firstName", "lastName", "publicName", "roleInCompany", "email", "roles", "totpEnabled", "intlPhoneNumber", "lastSuccessfulLogIn", "avatar", "createdAt", "updatedAt", "organization"]
