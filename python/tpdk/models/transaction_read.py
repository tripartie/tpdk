...
class TransactionRead(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ulid": obj.get("ulid"),
            "offer": OfferRead.from_dict(obj["offer"]) if obj.get("offer") is not None else None,
            "buyer": PersonaRead.from_dict(obj["buyer"]) if obj.get("buyer") is not None else None,
            "fees": obj.get("fees"),
