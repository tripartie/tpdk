...
class PersonaIndependentWrite(BaseModel):
    ...
    metadata: Optional[Annotated[List[MetadataIndependentWrite], Field(max_length=16)]] = Field(default=None, description="You can assign different meta to your Persona object for different purposes. eg. Ease searching.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": PersonaIndependentWriteAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
