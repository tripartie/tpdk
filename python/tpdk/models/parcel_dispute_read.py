...
class ParcelDisputeRead(BaseModel):
    """
      # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ParcelDisputeRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ParcelDisputeRead:
        """Create an instance of ParcelDisputeRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ParcelDisputeRead.parse_obj(obj)

        _obj = ParcelDisputeRead.parse_obj({
