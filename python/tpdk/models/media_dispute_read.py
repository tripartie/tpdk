...
class MediaDisputeRead(BaseModel):
    """
      # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MediaDisputeRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MediaDisputeRead:
        """Create an instance of MediaDisputeRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MediaDisputeRead.parse_obj(obj)

        _obj = MediaDisputeRead.parse_obj({
