...
class UserUserRead(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "avatar": MediaUserRead.from_dict(obj.get("avatar")) if obj.get("avatar") is not None else None,
            "createdAt": obj.get("createdAt"),
            "updatedAt": obj.get("updatedAt"),
            "consentMailNotification": obj.get("consentMailNotification"),
            "consentMailAds": obj.get("consentMailAds"),
            "organization": OrganizationUserRead.from_dict(obj.get("organization")) if obj.get("organization") is not None else None,
            "iri": obj.get("iri"),
