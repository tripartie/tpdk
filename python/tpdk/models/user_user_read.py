...
class UserUserRead(BaseModel):
    ...
    avatar: Optional[OrganizationUserReadIcon] = None
    ...
    organization: Optional[UserUserReadOrganization] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "avatar": OrganizationUserReadIcon.from_dict(obj["avatar"]) if obj.get("avatar") is not None else None,
            ...
            "organization": UserUserReadOrganization.from_dict(obj["organization"]) if obj.get("organization") is not None else None,
            "iri": obj.get("iri"),
