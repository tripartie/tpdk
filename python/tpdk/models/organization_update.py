...
class OrganizationUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "vatNumber", "commercialRegistryNumber", "websiteUrl", "customBaseUrl", "billingAddress", "primaryColor", "directNotificationToggle", "anonymityLevel", "internalMessagingToggle", "personaAuthPortalToggle", "automatedReturnToggle", "counterProposalToggle", "flatRateEnabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "billingAddress": AddressUpdate.from_dict(obj["billingAddress"]) if obj.get("billingAddress") is not None else None,
