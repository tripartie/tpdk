...
class DisputeOfferRead(BaseModel):
    """
    ...
    organization: Optional[DisputeOrganizationRead] = None
    seller: DisputePersonaRead = Field(description="If the seller is actually YOUR organization, set it to NULL.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organization": DisputeOrganizationRead.from_dict(obj["organization"]) if obj.get("organization") is not None else None,
            "seller": DisputePersonaRead.from_dict(obj["seller"]) if obj.get("seller") is not None else None,
            ...
            "medias": [DisputeMediaRead.from_dict(_item) for _item in obj["medias"]] if obj.get("medias") is not None else None
        })
        return _obj
