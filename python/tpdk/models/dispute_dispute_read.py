...
class DisputeDisputeRead(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ulid": obj.get("ulid"),
            "transaction": TransactionDisputeRead.from_dict(obj["transaction"]) if obj.get("transaction") is not None else None,
            ...
            "views": [ViewDisputeRead.from_dict(_item) for _item in obj["views"]] if obj.get("views") is not None else None,
            "metadata": [MetadataDisputeRead.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None,
            "events": [WorkflowEventDisputeRead.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
