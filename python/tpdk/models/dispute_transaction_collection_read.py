...
class DisputeTransactionCollectionRead(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ulid": obj.get("ulid"),
            "offer": DisputeOfferCollectionRead.from_dict(obj["offer"]) if obj.get("offer") is not None else None,
            "buyer": DisputePersonaCollectionRead.from_dict(obj["buyer"]) if obj.get("buyer") is not None else None
        })
        return _obj
