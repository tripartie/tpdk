...
class UserSupportRead(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserSupportRead:
    ...
    def from_dict(cls, obj: dict) -> UserSupportRead:
        ...
        _obj = UserSupportRead.parse_obj({
            ...
            "organization": UserSupportReadOrganization.from_dict(obj.get("organization")) if obj.get("organization") is not None else None
        })
        return _obj
