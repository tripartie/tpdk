...
class OfferOrganizationRead(BaseModel):
    """
    ...
    icon: Optional[OfferMediaRead] = None
    logo: Optional[OfferMediaRead] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icon": OfferMediaRead.from_dict(obj["icon"]) if obj.get("icon") is not None else None,
            "logo": OfferMediaRead.from_dict(obj["logo"]) if obj.get("logo") is not None else None,
