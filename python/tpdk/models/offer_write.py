...
class OfferWrite(BaseModel):
    ...
    metadata: Optional[List[OfferMetadataWrite]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": [OfferMetadataWrite.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None
        })
        return _obj
