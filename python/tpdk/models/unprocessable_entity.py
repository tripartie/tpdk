...
class UnprocessableEntity(BaseModel):
    ...
    violations: Optional[List[UnprocessableEntityViolationsInner]] = None
    __properties: ClassVar[List[str]] = ["type", "title", "detail", "violations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "violations": [UnprocessableEntityViolationsInner.from_dict(_item) for _item in obj["violations"]] if obj.get("violations") is not None else None
        })
        return _obj
