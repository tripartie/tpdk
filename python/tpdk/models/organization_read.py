...
class OrganizationRead(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "icon": MediaRead.from_dict(obj.get("icon")) if obj.get("icon") is not None else None,
            "logo": MediaRead.from_dict(obj.get("logo")) if obj.get("logo") is not None else None,
