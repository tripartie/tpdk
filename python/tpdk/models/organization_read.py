...
class OrganizationRead(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icon": EvidenceReadMedia.from_dict(obj["icon"]) if obj.get("icon") is not None else None,
            "logo": EvidenceReadMedia.from_dict(obj["logo"]) if obj.get("logo") is not None else None,
