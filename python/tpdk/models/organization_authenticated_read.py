...
class OrganizationAuthenticatedRead(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icon": OrganizationAuthenticatedReadIcon.from_dict(obj["icon"]) if obj.get("icon") is not None else None,
            "logo": OrganizationAuthenticatedReadIcon.from_dict(obj["logo"]) if obj.get("logo") is not None else None,
