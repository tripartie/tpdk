...
class UserEmailValidationWrite(BaseModel):
    """
    ...
    email_verification_input: Optional[Annotated[str, Field(min_length=128, strict=True, max_length=128)]] = Field(alias="emailVerificationInput")
    __properties: ClassVar[List[str]] = ["captcha", "plainPassword", "emailVerificationInput"]
