...
class OrganizationCollectionRead(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icon": MediaCollectionRead.from_dict(obj["icon"]) if obj.get("icon") is not None else None,
            "logo": MediaCollectionRead.from_dict(obj["logo"]) if obj.get("logo") is not None else None,
