...
class DisputeIndependentWrite(BaseModel):
    ...
    metadata: Optional[Annotated[List[DisputeMetadataIndependentWrite], Field(max_length=16)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transaction": DisputeTransactionIndependentWrite.from_dict(obj["transaction"]) if obj.get("transaction") is not None else None,
