...
class Dispute(BaseModel):
    ...
    evidences: conlist(StrictStr) = Field(...)
    evaluations: Optional[conlist(StrictStr)] = None
    views: conlist(View) = Field(...)
    metadata: conlist(Metadata) = Field(...)
    events: Optional[conlist(WorkflowEvent)] = None
    ...
    __properties = ["id", "ulid", "url", "transaction", "status", "redirectUrl", "itemCount", "issueType", "issueInDescriptionType", "issueMentionedInOffer", "issueDetails", "complainantTruthfulnessScore", "sellerTruthfulnessScore", "complainantStake", "inferredStake", "recommendedSolution", "recommendedPartialRefundAmount", "chosenSolution", "chosenPartialRefundAmount", "counterSolution", "counterPartialRefundAmount", "complainantApproval", "sellerApproval", "platformSolution", "platformPartialRefundAmount", "platformApproval", "arbitrationBy", "parcels", "messages", "evidences", "evaluations", "views", "metadata", "events", "createdAt", "updatedAt", "statusExpiration", "awaitedParty", "iri", "messageCount"]
    ...
    def from_dict(cls, obj: dict) -> Dispute:
        ...
        _obj = Dispute.parse_obj({
            ...
            "events": [WorkflowEvent.from_dict(_item) for _item in obj.get("events")] if obj.get("events") is not None else None,
