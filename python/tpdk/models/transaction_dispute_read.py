...
class TransactionDisputeRead(BaseModel):
    ...
    offer: OfferDisputeRead = Field(...)
    buyer: StrictStr = Field(...)
    fees: Optional[Union[StrictFloat, StrictInt]] = None
    metadata: Optional[conlist(MetadataDisputeRead)] = None
    parcels: Optional[conlist(ParcelDisputeRead)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionDisputeRead:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionDisputeRead:
        """Create an instance of TransactionDisputeRead from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionDisputeRead.parse_obj(obj)

        _obj = TransactionDisputeRead.parse_obj({
            "ulid": obj.get("ulid"),
