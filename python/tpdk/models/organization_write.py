...
class OrganizationWrite(BaseModel):
    ...
    billing_address: Optional[OrganizationWriteBillingAddress] = Field(default=None, alias="billingAddress")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "billingAddress": OrganizationWriteBillingAddress.from_dict(obj["billingAddress"]) if obj.get("billingAddress") is not None else None
        })
        return _obj
