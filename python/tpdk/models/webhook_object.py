...
class WebhookObject(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[Union[DisputeRead, OfferRead, PersonaRead]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: List[str] = Field(default=Literal["DisputeRead", "OfferRead", "PersonaRead"])
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], DisputeRead, OfferRead, PersonaRead]]:
