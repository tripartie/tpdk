...
WEBHOOKOBJECT_ANY_OF_SCHEMAS = ["DisputeRead", "PersonaRead"]
...
class WebhookObject(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[Union[DisputeRead, PersonaRead]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "DisputeRead", "PersonaRead" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = WebhookObject.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in WebhookObject with anyOf schemas: DisputeRead, PersonaRead. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into WebhookObject with anyOf schemas: DisputeRead, PersonaRead. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], DisputeRead, PersonaRead]]:
