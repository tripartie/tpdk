...
class DisputeRead(BaseModel):
    ...
    events: Optional[conlist(WorkflowEventRead)] = None
    ...
    __properties = ["ulid", "transaction", "status", "redirectUrl", "itemCount", "issueType", "issueInDescriptionType", "issueMentionedInOffer", "issueDetails", "complainantTruthfulnessScore", "sellerTruthfulnessScore", "complainantStake", "inferredStake", "recommendedSolution", "recommendedPartialRefundAmount", "chosenSolution", "chosenPartialRefundAmount", "counterSolution", "counterPartialRefundAmount", "complainantApproval", "sellerApproval", "platformSolution", "platformPartialRefundAmount", "platformApproval", "platformActorType", "arbitrationBy", "parcels", "metadata", "events", "createdAt", "updatedAt", "statusExpiration", "awaitedParty", "iri", "messageCount"]
    ...
    def from_dict(cls, obj: dict) -> DisputeRead:
        ...
        _obj = DisputeRead.parse_obj({
            ...
            "events": [WorkflowEventRead.from_dict(_item) for _item in obj.get("events")] if obj.get("events") is not None else None,
