...
class DisputeRead(BaseModel):
    ...
    """ # noqa: E501
    ulid: StrictStr
    transaction: Optional[DisputeTransactionRead] = None
    status: StrictStr
    ...
    parcels: List[DisputeParcelRead]
    views: List[DisputeViewRead]
    metadata: List[DisputeMetadataRead]
    events: Optional[List[DisputeWorkflowEventRead]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ulid": obj.get("ulid"),
            "transaction": DisputeTransactionRead.from_dict(obj["transaction"]) if obj.get("transaction") is not None else None,
            ...
            "views": [DisputeViewRead.from_dict(_item) for _item in obj["views"]] if obj.get("views") is not None else None,
            "metadata": [DisputeMetadataRead.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None,
            "events": [DisputeWorkflowEventRead.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
