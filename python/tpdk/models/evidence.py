...
class Evidence(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "dispute", "owner", "status", "media", "additionalInformation", "createdAt", "updatedAt", "publisher"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SUBMITTED', 'CORRELATED', 'UNRELATED', 'PENDING', 'TEMPERED', 'REJECTED']):
