...
class ResolutionCenterApi(object):
    ...
    @validate_arguments
    def api_disputes_ulidevidences_get_collection(self, ulid : Annotated[StrictStr, Field(..., description="Dispute identifier")], **kwargs) -> List[EvidenceRead]:  # noqa: E501
    ...
    @validate_arguments
    def api_disputes_ulidevidences_get_collection_with_http_info(self, ulid : Annotated[StrictStr, Field(..., description="Dispute identifier")], **kwargs) -> ApiResponse:  # noqa: E501
        """Retrieve all Evidences in Dispute  # noqa: E501
