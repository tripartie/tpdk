...
class ResolutionCenterApi(object):
    ...
    @validate_arguments
    def api_disputes_ulidparcels_id_get(self, ulid : StrictStr, id : StrictInt, **kwargs) -> ParcelRead:  # noqa: E501
        ...
        >>> thread = api.api_disputes_ulidparcels_id_get(ulid, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_disputes_ulidparcels_id_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_disputes_ulidparcels_id_get_with_http_info(ulid, id, **kwargs)  # noqa: E501

    @validate_arguments
    def api_disputes_ulidparcels_id_get_with_http_info(self, ulid : StrictStr, id : StrictInt, **kwargs) -> ApiResponse:  # noqa: E501
        """Read single parcel state  # noqa: E501
        ...
        >>> thread = api.api_disputes_ulidparcels_id_get_with_http_info(ulid, id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_disputes_ulidparcels_id_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
