...
class ResolutionCenterApi(object):
    ...
    @validate_arguments
    def api_disputes_ulidparcels_get_collection(self, ulid : Annotated[StrictStr, Field(..., description="Dispute identifier")], page : Annotated[Optional[StrictInt], Field(description="The collection page number")] = None, **kwargs) -> List[object]:  # noqa: E501
