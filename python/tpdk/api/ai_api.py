...
class AIApi:
    ...
    def api_ai_hints_post(self, ai_hint : Annotated[AiHint, Field(..., description="The new AiHint resource")], **kwargs) -> AiHint:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the api_ai_hints_post_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
