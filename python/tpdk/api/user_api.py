...
class UserApi(object):
    ...
    @validate_arguments
    def api_personasauthentication_post_with_http_info(self, persona : Annotated[Persona, Field(..., description="The new Persona resource")], **kwargs) -> ApiResponse:  # noqa: E501
        """Persona Authentication  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['persona'] is not None:
    ...
    @validate_arguments
    def api_users_get_collection(self, page : Annotated[Optional[StrictInt], Field(description="The collection page number")] = None, **kwargs) -> List[UserSupportRead]:  # noqa: E501
    ...
    def api_users_get_collection_with_http_info(self, page : Annotated[Optional[StrictInt], Field(description="The collection page number")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[UserSupportRead], status_code(int), headers(HTTPHeaderDict))
        """
