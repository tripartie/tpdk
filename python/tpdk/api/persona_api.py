...
class PersonaApi:
    ...
    @validate_call
    def api_personas_idtoken_post(
        self,
        id: Annotated[StrictStr, Field(description="Persona identifier")],
        persona_token_write: Annotated[PersonaTokenWrite, Field(description="The new Persona resource")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._api_personas_idtoken_post_serialize(
            id=id,
            persona_token_write=persona_token_write,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def api_personas_idtoken_post_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Persona identifier")],
        persona_token_write: Annotated[PersonaTokenWrite, Field(description="The new Persona resource")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PersonaPostAuthRead]:
        """Issue authenticated URL for single end-user
    ...
    @validate_call
    def api_personas_idtoken_post_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Persona identifier")],
        persona_token_write: Annotated[PersonaTokenWrite, Field(description="The new Persona resource")],
        _request_timeout: Union[
    ...
    def _api_personas_idtoken_post_serialize(
        self,
        id,
        persona_token_write,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if persona_token_write is not None:
            _body_params = persona_token_write
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/personas/{id}/token',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
