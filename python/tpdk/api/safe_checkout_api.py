...
from tpdk.api_client import ApiClient, RequestSerialized
...
class SafeCheckoutApi:
    ...
    def api_offers_ulidtransactions_idevaluations_post(
        self,
        ulid: Annotated[StrictStr, Field(description="Evaluation identifier")],
        id: Annotated[StrictStr, Field(description="Evaluation identifier")],
    ...
    def api_personas_idoffers_delete(
        self,
        id: Annotated[StrictStr, Field(description="Offer identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
