...
class TestDisputeOfferRead(unittest.TestCase):
    """DisputeOfferRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DisputeOfferRead:
        """Test DisputeOfferRead
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DisputeOfferRead`
        """
        model = DisputeOfferRead()
        if include_optional:
            return DisputeOfferRead(
                ulid = '',
