...
from tpdk.models.offer_dispute_read import OfferDisputeRead  # noqa: E501

class TestOfferDisputeRead(unittest.TestCase):
    """OfferDisputeRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OfferDisputeRead:
        """Test OfferDisputeRead
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OfferDisputeRead`
        """
        model = OfferDisputeRead()  # noqa: E501
        if include_optional:
            return OfferDisputeRead(
                ulid = '',
                ...
                condition = 'USED',
                medias = [
                    tpdk.models.media_dispute/read.Media-dispute.read(
                        public_url = 'https://cdn.tripartie.app/b15e64db-fbd2-442b-afee-69ee45e2959b.jpg', )
                    ]
            )
        else:
