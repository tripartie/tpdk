    ...
    def make_instance(self, include_optional) -> UserAuthenticatedRead:
        ...
        if include_optional:
            return UserAuthenticatedRead(
                ...
                avatar = tpdk.models.dispute_media_read.Dispute-Media-Read(
                ...
                lockdown = True,
                organization = tpdk.models.user_organization_authenticated_read.User-Organization-AuthenticatedRead(
                    id = 56, 
                    name = '', 
