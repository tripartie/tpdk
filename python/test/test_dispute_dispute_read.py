...
from tpdk.models.dispute_dispute_read import DisputeDisputeRead  # noqa: E501
...
class TestDisputeDisputeRead(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DisputeDisputeRead:
        ...
        """
        model = DisputeDisputeRead()  # noqa: E501
        if include_optional:
            return DisputeDisputeRead(
                ...
                transaction = tpdk.models.transaction_dispute/read.Transaction-dispute.read(
                    ...
                    fees = 1.337, 
                    metadata = [
                        tpdk.models.metadata_dispute/read.Metadata-dispute.read(
                            key = 'External-ID', 
                            value = '54412', )
                        ], 
                    parcels = [
                ...
                events = [
                    tpdk.models.workflow_event_dispute/read.WorkflowEvent-dispute.read(
                        label = '', 
                        from = '', 
                        to = '', 
