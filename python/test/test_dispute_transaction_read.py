...
class TestDisputeTransactionRead(unittest.TestCase):
    """DisputeTransactionRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DisputeTransactionRead:
        """Test DisputeTransactionRead
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DisputeTransactionRead`
        """
        model = DisputeTransactionRead()
        if include_optional:
            return DisputeTransactionRead(
                ulid = '',
                offer = tpdk.models.dispute_offer_read.Dispute-Offer-Read(
                    ulid = '', 
                    public_url = 'https://marketplace.tld/offers/that-special-item-i-wish-to-sold', 
                    organization = tpdk.models.dispute_organization_read.Dispute-Organization-Read(
                        name = '', 
                        website_url = '', 
                        custom_base_url = '', 
                    ...
                    seller = tpdk.models.dispute_persona_read.Dispute-Persona-Read(
                        id = 56, 
                        first_name = 'John', 
                        last_name = 'Doe', 
                        language = 'fr', 
                ...
                buyer = tpdk.models.dispute_persona_read.Dispute-Persona-Read(
                    id = 56, 
                    first_name = 'John', 
                    last_name = 'Doe', 
                    language = 'fr', 
                ...
                parcels = [
                    tpdk.models.dispute_parcel_read.Dispute-Parcel-Read(
                        carrier = 'SwissPost', 
    ...
    def testDisputeTransactionRead(self):
        """Test DisputeTransactionRead"""
