    ...
    def make_instance(self, include_optional) -> UserWrite:
        ...
        if include_optional:
            return UserWrite(
                ...
                organization = tpdk.models.user_organization_write.User-Organization-Write(
                    id = 56, 
                    name = '', 
                    vat_number = '', 
                    commercial_registry_number = '', 
                    website_url = '', 
                    billing_address = tpdk.models.dispute_address_independent_write.Dispute-Address-IndependentWrite(
