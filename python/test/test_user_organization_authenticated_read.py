...
class TestUserOrganizationAuthenticatedRead(unittest.TestCase):
    """UserOrganizationAuthenticatedRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserOrganizationAuthenticatedRead:
        """Test UserOrganizationAuthenticatedRead
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserOrganizationAuthenticatedRead`
        """
        model = UserOrganizationAuthenticatedRead()
        if include_optional:
            return UserOrganizationAuthenticatedRead(
                id = 56,
                name = '',
    ...
    def testUserOrganizationAuthenticatedRead(self):
        """Test UserOrganizationAuthenticatedRead"""
