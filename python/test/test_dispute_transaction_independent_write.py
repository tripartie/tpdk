...
class TestDisputeTransactionIndependentWrite(unittest.TestCase):
    """DisputeTransactionIndependentWrite unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DisputeTransactionIndependentWrite:
        """Test DisputeTransactionIndependentWrite
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DisputeTransactionIndependentWrite`
        """
        model = DisputeTransactionIndependentWrite()
        if include_optional:
            return DisputeTransactionIndependentWrite(
                offer = tpdk.models.dispute_offer_independent_write.Dispute-Offer-IndependentWrite(
                    public_url = 'https://marketplace.tld/offers/that-special-item-i-wish-to-sold', 
                    seller = tpdk.models.dispute_persona_independent_write.Dispute-Persona-IndependentWrite(
                        first_name = 'John', 
                        last_name = 'Doe', 
                ...
                buyer = tpdk.models.dispute_persona_independent_write.Dispute-Persona-IndependentWrite(
                    first_name = 'John', 
                    last_name = 'Doe', 
                    gender = 'RATHER_NOT_SAY', 
                    date_of_birth = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                ...
                parcels = [
                    tpdk.models.dispute_parcel_independent_write.Dispute-Parcel-IndependentWrite(
                        carrier = 'SwissPost', 
    ...
    def testDisputeTransactionIndependentWrite(self):
        """Test DisputeTransactionIndependentWrite"""
