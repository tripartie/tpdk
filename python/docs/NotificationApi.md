# tpdk.NotificationApi

All URIs are relative to *https://staging-api.tripartie.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**api_personas_idnotifications_get_collection**](NotificationApi.md#api_personas_idnotifications_get_collection) | **GET** /personas/{id}/notifications | Retrieves the collection of Notification resources.
[**api_personas_persona_idnotifications_id_patch**](NotificationApi.md#api_personas_persona_idnotifications_id_patch) | **PATCH** /personas/{personaId}/notifications/{id} | Updates the Notification resource.
...
[**api_users_user_idnotifications_id_patch**](NotificationApi.md#api_users_user_idnotifications_id_patch) | **PATCH** /users/{userId}/notifications/{id} | Updates the Notification resource.
