...
*ResolutionCenterApi* | [**api_offers_ulidmedias_id_delete**](docs/ResolutionCenterApi.md#api_offers_ulidmedias_id_delete) | **DELETE** /offers/{ulid}/medias/{id} | Removes the Media resource.
