...
*ResolutionCenterApi* | [**api_disputes_ulidparcels_id_get**](docs/ResolutionCenterApi.md#api_disputes_ulidparcels_id_get) | **GET** /disputes/{ulid}/parcels/{id} | Read single parcel state
