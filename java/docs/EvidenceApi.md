...
<a id="apiEvidencesIdGet"></a>
# **apiEvidencesIdGet**
> Evidence apiEvidencesIdGet(id).execute();
...
import com.tripartie.tpdk.api.EvidenceApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    EvidenceApi apiInstance = new EvidenceApi(defaultClient);
    String id = "id_example"; // String | Evidence identifier
    try {
      Evidence result = apiInstance.apiEvidencesIdGet(id)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EvidenceApi#apiEvidencesIdGet");
