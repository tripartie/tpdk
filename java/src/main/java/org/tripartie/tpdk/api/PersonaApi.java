...
import org.tripartie.tpdk.model.PersonaPostAuthRead;
import org.tripartie.tpdk.model.PersonaRead;
import org.tripartie.tpdk.model.PersonaTokenWrite;
import org.tripartie.tpdk.model.PersonaUpdate;
import org.tripartie.tpdk.model.PersonaWrite;
...
public class PersonaApi {
     ...
     * @param gender Filter on a limited subset of gender (optional)
     ...
     */
    public okhttp3.Call apiPersonasGetCollectionCall(Integer page, String firstName, String lastName, String email, List<String> email2, String mobilePhoneNumber, List<String> mobilePhoneNumber2, String gender, String orderCreatedAt, String createdAtBefore, String createdAtStrictlyBefore, String createdAtAfter, String createdAtStrictlyAfter, String dateOfBirthBefore, String dateOfBirthStrictlyBefore, String dateOfBirthAfter, String dateOfBirthStrictlyAfter, List<String> metadata, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call apiPersonasGetCollectionValidateBeforeCall(Integer page, String firstName, String lastName, String email, List<String> email2, String mobilePhoneNumber, List<String> mobilePhoneNumber2, String gender, String orderCreatedAt, String createdAtBefore, String createdAtStrictlyBefore, String createdAtAfter, String createdAtStrictlyAfter, String dateOfBirthBefore, String dateOfBirthStrictlyBefore, String dateOfBirthAfter, String dateOfBirthStrictlyAfter, List<String> metadata, final ApiCallback _callback) throws ApiException {
        return apiPersonasGetCollectionCall(page, firstName, lastName, email, email2, mobilePhoneNumber, mobilePhoneNumber2, gender, orderCreatedAt, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, dateOfBirthBefore, dateOfBirthStrictlyBefore, dateOfBirthAfter, dateOfBirthStrictlyAfter, metadata, _callback);
     ...
     */
    public ApiResponse<List<PersonaCollectionRead>> apiPersonasGetCollectionWithHttpInfo(Integer page, String firstName, String lastName, String email, List<String> email2, String mobilePhoneNumber, List<String> mobilePhoneNumber2, String gender, String orderCreatedAt, String createdAtBefore, String createdAtStrictlyBefore, String createdAtAfter, String createdAtStrictlyAfter, String dateOfBirthBefore, String dateOfBirthStrictlyBefore, String dateOfBirthAfter, String dateOfBirthStrictlyAfter, List<String> metadata) throws ApiException {
        okhttp3.Call localVarCall = apiPersonasGetCollectionValidateBeforeCall(page, firstName, lastName, email, email2, mobilePhoneNumber, mobilePhoneNumber2, gender, orderCreatedAt, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, dateOfBirthBefore, dateOfBirthStrictlyBefore, dateOfBirthAfter, dateOfBirthStrictlyAfter, metadata, null);
        Type localVarReturnType = new TypeToken<List<PersonaCollectionRead>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieves the collection of Persona resources. (asynchronously)
     * Retrieves the collection of Persona resources.
     * @param page The collection page number (optional, default to 1)
     * @param firstName  (optional)
     * @param lastName  (optional)
     ...
     */
    public okhttp3.Call apiPersonasGetCollectionAsync(Integer page, String firstName, String lastName, String email, List<String> email2, String mobilePhoneNumber, List<String> mobilePhoneNumber2, String gender, String orderCreatedAt, String createdAtBefore, String createdAtStrictlyBefore, String createdAtAfter, String createdAtStrictlyAfter, String dateOfBirthBefore, String dateOfBirthStrictlyBefore, String dateOfBirthAfter, String dateOfBirthStrictlyAfter, List<String> metadata, final ApiCallback<List<PersonaCollectionRead>> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call apiPersonasIdDeleteCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
     ...
     */
    public void apiPersonasIdDelete(String id) throws ApiException {
     ...
     */
    public ApiResponse<Void> apiPersonasIdDeleteWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = apiPersonasIdDeleteValidateBeforeCall(id, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Unregister a Persona (Your customer) (asynchronously)
     * You **MAY** unregister (or free the email/phone number) your Persona entry using that endpoint. *Please note that* this operation will fail if that Persona have any ongoing operations.
     * @param id Persona identifier (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call apiPersonasIdDeleteAsync(String id, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call apiPersonasIdGetCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
     ...
     */
    public PersonaRead apiPersonasIdGet(String id) throws ApiException {
     ...
     */
    public ApiResponse<PersonaRead> apiPersonasIdGetWithHttpInfo(String id) throws ApiException {
    ...
    /**
     * Retrieves a Persona resource. (asynchronously)
     * Retrieves a Persona resource.
     * @param id Persona identifier (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call apiPersonasIdGetAsync(String id, final ApiCallback<PersonaRead> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call apiPersonasIdPatchCall(String id, PersonaUpdate personaUpdate, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
     ...
     */
    public PersonaRead apiPersonasIdPatch(String id, PersonaUpdate personaUpdate) throws ApiException {
     ...
     */
    public ApiResponse<PersonaRead> apiPersonasIdPatchWithHttpInfo(String id, PersonaUpdate personaUpdate) throws ApiException {
    ...
    /**
     * Updates the Persona resource. (asynchronously)
     * Update your Persona (eg. your customer/user entry) through that API call. _Beware that updating_ **email** and/or the **mobile phone number** must be done using non reserved values. Otherwise this operation will be rejected.
     * @param id Persona identifier (required)
     * @param personaUpdate The updated Persona resource (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call apiPersonasIdPatchAsync(String id, PersonaUpdate personaUpdate, final ApiCallback<PersonaRead> _callback) throws ApiException {
    ...
    /**
     * Build call for apiPersonasIdtokenPost
     * @param id Persona identifier (required)
     * @param personaTokenWrite The new Persona resource (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call apiPersonasIdtokenPostCall(String id, PersonaTokenWrite personaTokenWrite, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = personaTokenWrite;

        // create path and map variables
        String localVarPath = "/personas/{id}/token"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiPersonasIdtokenPostValidateBeforeCall(String id, PersonaTokenWrite personaTokenWrite, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling apiPersonasIdtokenPost(Async)");
        }

        // verify the required parameter 'personaTokenWrite' is set
        if (personaTokenWrite == null) {
            throw new ApiException("Missing the required parameter 'personaTokenWrite' when calling apiPersonasIdtokenPost(Async)");
        }

        return apiPersonasIdtokenPostCall(id, personaTokenWrite, _callback);
     ...
     */
    public PersonaPostAuthRead apiPersonasIdtokenPost(String id, PersonaTokenWrite personaTokenWrite) throws ApiException {
        ApiResponse<PersonaPostAuthRead> localVarResp = apiPersonasIdtokenPostWithHttpInfo(id, personaTokenWrite);
        return localVarResp.getData();
    }
     ...
     * @param id Persona identifier (required)
     * @param personaTokenWrite The new Persona resource (required)
     * @return ApiResponse&lt;PersonaPostAuthRead&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PersonaPostAuthRead> apiPersonasIdtokenPostWithHttpInfo(String id, PersonaTokenWrite personaTokenWrite) throws ApiException {
        okhttp3.Call localVarCall = apiPersonasIdtokenPostValidateBeforeCall(id, personaTokenWrite, null);
        Type localVarReturnType = new TypeToken<PersonaPostAuthRead>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Issue authenticated URL for single end-user (asynchronously)
     * Without this, your users may be required to pass a MFA challenge even if they are already logged-in from your website. Pass the URL you wish your user access, either a Dispute or Safe-checkout resource.
     * @param id Persona identifier (required)
     * @param personaTokenWrite The new Persona resource (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call apiPersonasIdtokenPostAsync(String id, PersonaTokenWrite personaTokenWrite, final ApiCallback<PersonaPostAuthRead> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiPersonasIdtokenPostValidateBeforeCall(id, personaTokenWrite, _callback);
        Type localVarReturnType = new TypeToken<PersonaPostAuthRead>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call apiPersonasPostCall(PersonaWrite personaWrite, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
     ...
     */
    public PersonaRead apiPersonasPost(PersonaWrite personaWrite) throws ApiException {
     ...
     */
    public ApiResponse<PersonaRead> apiPersonasPostWithHttpInfo(PersonaWrite personaWrite) throws ApiException {
    ...
    /**
     * Register a Persona (Your customer) (asynchronously)
     * You should not register your whole database of users, only those who are concerned by a Safe-checkout or Dispute operation. One Persona entry for your organization can be assigned as a seller or buyer.  **Notes:**   - (i) There is a unique constraint for the mobile phone numbers and email.   - (ii) You will have to issue a DELETE operation on a Persona that withhold a specific phone number or email.   - (iii) You are NOT REQUIRED to provide email OR a mobile phone number but it is highly recommended, if none provided the email will be generated as &#39;{ulid}@your-domain.tld&#39;. In that case, please specify at least one metadata in order to find your entry with ease.
     * @param personaWrite The new Persona resource (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call apiPersonasPostAsync(PersonaWrite personaWrite, final ApiCallback<PersonaRead> _callback) throws ApiException {
