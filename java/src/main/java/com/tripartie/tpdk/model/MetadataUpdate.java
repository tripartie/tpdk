...
public class MetadataUpdate {
  ...
  public MetadataUpdate key(String key) {
    this.key = key;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, metadataUpdate.key) &&
  ...
  * @throws IOException if the JSON Element is invalid with respect to MetadataUpdate
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MetadataUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetadataUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetadataUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
