...
public class DisputeCollectionRead {
  ...
  private DisputeTransactionCollectionRead transaction;
  ...
  **/
  ...
  public DisputeCollectionRead transaction(DisputeTransactionCollectionRead transaction) {
  ...
  **/
  ...
  public DisputeTransactionCollectionRead getTransaction() {
    return transaction;
  }

  public void setTransaction(DisputeTransactionCollectionRead transaction) {
    this.transaction = transaction;
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("transaction") != null && !jsonObj.get("transaction").isJsonNull()) {
        DisputeTransactionCollectionRead.validateJsonElement(jsonObj.get("transaction"));
      }
