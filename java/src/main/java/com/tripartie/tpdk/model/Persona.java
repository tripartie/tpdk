...
public class Persona {
  ...
  private PersonaAddress address;
  ...
  **/
  ...
  public Persona address(PersonaAddress address) {
  ...
  **/
  @javax.annotation.Nullable
  public PersonaAddress getAddress() {
    return address;
  }

  public void setAddress(PersonaAddress address) {
    this.address = address;
  }
  ...
  **/
  ...
  public Persona purchases(Object purchases) {
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("address") != null && !jsonObj.get("address").isJsonNull()) {
        PersonaAddress.validateJsonElement(jsonObj.get("address"));
      }
