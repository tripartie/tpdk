...
public class AddressWrite {
  ...
  public AddressWrite companyName(String companyName) {
  ...
  **/
  ...
  public AddressWrite countryCode(String countryCode) {
  ...
  **/
  ...
  public AddressWrite zipCode(String zipCode) {
  ...
  **/
  ...
  public AddressWrite cityName(String cityName) {
  ...
  **/
  ...
  public AddressWrite firstLine(String firstLine) {
  ...
  **/
  ...
  public AddressWrite secondLine(String secondLine) {
  ...
  **/
  ...
  public AddressWrite buildingName(String buildingName) {
  ...
  **/
  ...
  public AddressWrite buildingFloor(String buildingFloor) {
  ...
  **/
  ...
  public AddressWrite gateOrPortalOrInboxCode(String gateOrPortalOrInboxCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AddressWrite addressWrite = (AddressWrite) o;
    return Objects.equals(this.companyName, addressWrite.companyName) &&
        Objects.equals(this.countryCode, addressWrite.countryCode) &&
        Objects.equals(this.zipCode, addressWrite.zipCode) &&
        Objects.equals(this.cityName, addressWrite.cityName) &&
        Objects.equals(this.firstLine, addressWrite.firstLine) &&
        Objects.equals(this.secondLine, addressWrite.secondLine) &&
        Objects.equals(this.buildingName, addressWrite.buildingName) &&
        Objects.equals(this.buildingFloor, addressWrite.buildingFloor) &&
        Objects.equals(this.gateOrPortalOrInboxCode, addressWrite.gateOrPortalOrInboxCode);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to AddressWrite
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddressWrite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddressWrite is not found in the empty JSON string", AddressWrite.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddressWrite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddressWrite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddressWrite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddressWrite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddressWrite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddressWrite.class));

       return (TypeAdapter<T>) new TypeAdapter<AddressWrite>() {
           @Override
           public void write(JsonWriter out, AddressWrite value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddressWrite read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AddressWrite given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddressWrite
  * @throws IOException if the JSON string is invalid with respect to AddressWrite
  */
  public static AddressWrite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddressWrite.class);
  }

 /**
  * Convert an instance of AddressWrite to an JSON string
  *
  * @return JSON string
  */
