...
public class UserWrite {
  ...
  private OrganizationWrite organization;
  ...
  **/
  ...
  public UserWrite organization(OrganizationWrite organization) {
  ...
  **/
  @javax.annotation.Nullable
  public OrganizationWrite getOrganization() {
    return organization;
  }

  public void setOrganization(OrganizationWrite organization) {
    this.organization = organization;
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("organization") != null && !jsonObj.get("organization").isJsonNull()) {
        OrganizationWrite.validateJsonElement(jsonObj.get("organization"));
      }
  }
