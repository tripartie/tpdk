...
public class UserAddressWrite {
  ...
  public UserAddressWrite() {
  }

  public UserAddressWrite companyName(String companyName) {
  ...
  **/
  ...
  public UserAddressWrite countryCode(String countryCode) {
  ...
  **/
  ...
  public UserAddressWrite zipCode(String zipCode) {
  ...
  **/
  ...
  public UserAddressWrite cityName(String cityName) {
  ...
  **/
  ...
  public UserAddressWrite firstLine(String firstLine) {
  ...
  **/
  ...
  public UserAddressWrite secondLine(String secondLine) {
  ...
  **/
  ...
  public UserAddressWrite buildingName(String buildingName) {
  ...
  **/
  ...
  public UserAddressWrite buildingFloor(String buildingFloor) {
  ...
  **/
  ...
  public UserAddressWrite gateOrPortalOrInboxCode(String gateOrPortalOrInboxCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserAddressWrite userAddressWrite = (UserAddressWrite) o;
    return Objects.equals(this.companyName, userAddressWrite.companyName) &&
        Objects.equals(this.countryCode, userAddressWrite.countryCode) &&
        Objects.equals(this.zipCode, userAddressWrite.zipCode) &&
        Objects.equals(this.cityName, userAddressWrite.cityName) &&
        Objects.equals(this.firstLine, userAddressWrite.firstLine) &&
        Objects.equals(this.secondLine, userAddressWrite.secondLine) &&
        Objects.equals(this.buildingName, userAddressWrite.buildingName) &&
        Objects.equals(this.buildingFloor, userAddressWrite.buildingFloor) &&
        Objects.equals(this.gateOrPortalOrInboxCode, userAddressWrite.gateOrPortalOrInboxCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserAddressWrite {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserAddressWrite
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserAddressWrite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserAddressWrite is not found in the empty JSON string", UserAddressWrite.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserAddressWrite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserAddressWrite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserAddressWrite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserAddressWrite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserAddressWrite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserAddressWrite.class));

       return (TypeAdapter<T>) new TypeAdapter<UserAddressWrite>() {
           @Override
           public void write(JsonWriter out, UserAddressWrite value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserAddressWrite read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserAddressWrite given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserAddressWrite
  * @throws IOException if the JSON string is invalid with respect to UserAddressWrite
  */
  public static UserAddressWrite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserAddressWrite.class);
  }

 /**
  * Convert an instance of UserAddressWrite to an JSON string
  *
  * @return JSON string
  */
