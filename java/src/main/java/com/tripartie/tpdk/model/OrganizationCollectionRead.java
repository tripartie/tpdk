...
public class OrganizationCollectionRead {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, vatNumber, commercialRegistryNumber, websiteUrl, icon, logo, directNotificationToggle, internalMessagingToggle, personaAuthPortalToggle, automatedReturnToggle, counterProposalToggle, flatRateEnabled);
  }
