...
public class DisputeRead {
  ...
  private DisputeTransactionRead transaction;
  ...
  private List<DisputeViewRead> views = new ArrayList<>();
  ...
  private List<DisputeWorkflowEventRead> events = new ArrayList<>();
  ...
  **/
  ...
  public DisputeRead transaction(DisputeTransactionRead transaction) {
  ...
  **/
  ...
  public DisputeTransactionRead getTransaction() {
    return transaction;
  }

  public void setTransaction(DisputeTransactionRead transaction) {
    this.transaction = transaction;
  }
  ...
  **/
  ...
  public DisputeRead parcels(List<DisputeParcelRead> parcels) {
    this.parcels = parcels;
    return this;
  }

  public DisputeRead addParcelsItem(DisputeParcelRead parcelsItem) {
  ...
  **/
  ...
  public DisputeRead views(List<DisputeViewRead> views) {
    this.views = views;
    return this;
  }

  public DisputeRead addViewsItem(DisputeViewRead viewsItem) {
    if (this.views == null) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<DisputeViewRead> getViews() {
    return views;
  }

  public void setViews(List<DisputeViewRead> views) {
    this.views = views;
  }


  public DisputeRead metadata(List<DisputeMetadataRead> metadata) {
    this.metadata = metadata;
    return this;
  }

  public DisputeRead addMetadataItem(DisputeMetadataRead metadataItem) {
  ...
  **/
  ...
  public DisputeRead events(List<DisputeWorkflowEventRead> events) {
    this.events = events;
    return this;
  }

  public DisputeRead addEventsItem(DisputeWorkflowEventRead eventsItem) {
    if (this.events == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<DisputeWorkflowEventRead> getEvents() {
    return events;
  }

  public void setEvents(List<DisputeWorkflowEventRead> events) {
    this.events = events;
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("transaction") != null && !jsonObj.get("transaction").isJsonNull()) {
        DisputeTransactionRead.validateJsonElement(jsonObj.get("transaction"));
      }
      ...
      for (int i = 0; i < jsonArrayviews.size(); i++) {
        DisputeViewRead.validateJsonElement(jsonArrayviews.get(i));
      };
      // ensure the json data is an array
      ...
      if (jsonObj.get("events") != null && !jsonObj.get("events").isJsonNull()) {
        ...
        if (jsonArrayevents != null) {
          ...
          for (int i = 0; i < jsonArrayevents.size(); i++) {
            DisputeWorkflowEventRead.validateJsonElement(jsonArrayevents.get(i));
          };
        }
      }
