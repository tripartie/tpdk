 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-25T08:06:09.794909Z[Etc/UTC]", comments = "Generator version: 7.4.0")
public class DisputeRead {
  ...
  private List<ViewRead> views = new ArrayList<>();
  ...
  private List<WorkflowEventRead> events;
  ...
  public DisputeRead ulid(String ulid) {
    this.ulid = ulid;
    return this;
  }
  ...
  **/
  ...
  public DisputeRead transaction(TransactionRead transaction) {
  ...
  **/
  ...
  public TransactionRead getTransaction() {
    return transaction;
  }

  public void setTransaction(TransactionRead transaction) {
    this.transaction = transaction;
  }


  public DisputeRead status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public DisputeRead redirectUrl(String redirectUrl) {
  ...
  **/
  ...
  public DisputeRead itemCount(Integer itemCount) {
  ...
  **/
  ...
  public DisputeRead issueType(IssueTypeEnum issueType) {
  ...
  **/
  ...
  public DisputeRead issueInDescriptionType(IssueInDescriptionTypeEnum issueInDescriptionType) {
  ...
  **/
  ...
  public DisputeRead issueMentionedInOffer(Boolean issueMentionedInOffer) {
  ...
  **/
  ...
  public DisputeRead issueDetails(String issueDetails) {
  ...
  **/
  ...
  public DisputeRead complainantTruthfulnessScore(Integer complainantTruthfulnessScore) {
  ...
  **/
  ...
  public DisputeRead sellerTruthfulnessScore(Integer sellerTruthfulnessScore) {
  ...
  **/
  ...
  public DisputeRead complainantStake(ComplainantStakeEnum complainantStake) {
  ...
  **/
  ...
  public DisputeRead inferredStake(InferredStakeEnum inferredStake) {
  ...
  **/
  ...
  public DisputeRead recommendedSolution(RecommendedSolutionEnum recommendedSolution) {
  ...
  **/
  ...
  public DisputeRead recommendedPartialRefundAmount(Integer recommendedPartialRefundAmount) {
  ...
  **/
  ...
  public DisputeRead chosenSolution(ChosenSolutionEnum chosenSolution) {
  ...
  **/
  ...
  public DisputeRead chosenPartialRefundAmount(Integer chosenPartialRefundAmount) {
  ...
  **/
  ...
  public DisputeRead counterSolution(CounterSolutionEnum counterSolution) {
  ...
  **/
  ...
  public DisputeRead counterPartialRefundAmount(Integer counterPartialRefundAmount) {
  ...
  **/
  ...
  public DisputeRead sellerNotes(String sellerNotes) {
  ...
  **/
  ...
  public DisputeRead sellerRejectionReason(SellerRejectionReasonEnum sellerRejectionReason) {
  ...
  **/
  ...
  public DisputeRead complainantApproval(Boolean complainantApproval) {
  ...
  **/
  ...
  public DisputeRead sellerApproval(Boolean sellerApproval) {
  ...
  **/
  ...
  public DisputeRead platformSolution(PlatformSolutionEnum platformSolution) {
  ...
  **/
  ...
  public DisputeRead platformPartialRefundAmount(Integer platformPartialRefundAmount) {
  ...
  **/
  ...
  public DisputeRead platformApproval(Boolean platformApproval) {
  ...
  **/
  ...
  public DisputeRead platformActorType(PlatformActorTypeEnum platformActorType) {
  ...
  **/
  ...
  public DisputeRead platformReasoning(String platformReasoning) {
  ...
  **/
  ...
  public DisputeRead arbitrationBy(String arbitrationBy) {
  ...
  **/
  ...
  public DisputeRead parcels(List<ParcelRead> parcels) {
    this.parcels = parcels;
    return this;
  }

  public DisputeRead addParcelsItem(ParcelRead parcelsItem) {
  ...
  **/
  ...
  public DisputeRead views(List<ViewRead> views) {
    this.views = views;
    return this;
  }

  public DisputeRead addViewsItem(ViewRead viewsItem) {
    if (this.views == null) {
  ...
  **/
  @javax.annotation.Nonnull
  public List<ViewRead> getViews() {
    return views;
  }

  public void setViews(List<ViewRead> views) {
    this.views = views;
  }


  public DisputeRead metadata(List<MetadataRead> metadata) {
    this.metadata = metadata;
    return this;
  }

  public DisputeRead addMetadataItem(MetadataRead metadataItem) {
  ...
  **/
  ...
  public DisputeRead events(List<WorkflowEventRead> events) {
    this.events = events;
    return this;
  }

  public DisputeRead addEventsItem(WorkflowEventRead eventsItem) {
    if (this.events == null) {
  ...
  **/
  @javax.annotation.Nullable
  public List<WorkflowEventRead> getEvents() {
    return events;
  }

  public void setEvents(List<WorkflowEventRead> events) {
    this.events = events;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DisputeRead disputeRead = (DisputeRead) o;
    return Objects.equals(this.ulid, disputeRead.ulid) &&
        Objects.equals(this.transaction, disputeRead.transaction) &&
        Objects.equals(this.status, disputeRead.status) &&
        Objects.equals(this.redirectUrl, disputeRead.redirectUrl) &&
        Objects.equals(this.itemCount, disputeRead.itemCount) &&
        Objects.equals(this.issueType, disputeRead.issueType) &&
        Objects.equals(this.issueInDescriptionType, disputeRead.issueInDescriptionType) &&
        Objects.equals(this.issueMentionedInOffer, disputeRead.issueMentionedInOffer) &&
        Objects.equals(this.issueDetails, disputeRead.issueDetails) &&
        Objects.equals(this.complainantTruthfulnessScore, disputeRead.complainantTruthfulnessScore) &&
        Objects.equals(this.sellerTruthfulnessScore, disputeRead.sellerTruthfulnessScore) &&
        Objects.equals(this.complainantStake, disputeRead.complainantStake) &&
        Objects.equals(this.inferredStake, disputeRead.inferredStake) &&
        Objects.equals(this.recommendedSolution, disputeRead.recommendedSolution) &&
        Objects.equals(this.recommendedPartialRefundAmount, disputeRead.recommendedPartialRefundAmount) &&
        Objects.equals(this.chosenSolution, disputeRead.chosenSolution) &&
        Objects.equals(this.chosenPartialRefundAmount, disputeRead.chosenPartialRefundAmount) &&
        Objects.equals(this.counterSolution, disputeRead.counterSolution) &&
        Objects.equals(this.counterPartialRefundAmount, disputeRead.counterPartialRefundAmount) &&
        Objects.equals(this.sellerNotes, disputeRead.sellerNotes) &&
        Objects.equals(this.sellerRejectionReason, disputeRead.sellerRejectionReason) &&
        Objects.equals(this.complainantApproval, disputeRead.complainantApproval) &&
        Objects.equals(this.sellerApproval, disputeRead.sellerApproval) &&
        Objects.equals(this.platformSolution, disputeRead.platformSolution) &&
        Objects.equals(this.platformPartialRefundAmount, disputeRead.platformPartialRefundAmount) &&
        Objects.equals(this.platformApproval, disputeRead.platformApproval) &&
        Objects.equals(this.platformActorType, disputeRead.platformActorType) &&
        Objects.equals(this.platformReasoning, disputeRead.platformReasoning) &&
        Objects.equals(this.arbitrationBy, disputeRead.arbitrationBy) &&
        Objects.equals(this.parcels, disputeRead.parcels) &&
        Objects.equals(this.views, disputeRead.views) &&
        Objects.equals(this.metadata, disputeRead.metadata) &&
        Objects.equals(this.events, disputeRead.events) &&
        Objects.equals(this.createdAt, disputeRead.createdAt) &&
        Objects.equals(this.updatedAt, disputeRead.updatedAt) &&
        Objects.equals(this.viewCount, disputeRead.viewCount) &&
        Objects.equals(this.statusExpiration, disputeRead.statusExpiration) &&
        Objects.equals(this.awaitedParty, disputeRead.awaitedParty) &&
        Objects.equals(this.iri, disputeRead.iri) &&
        Objects.equals(this.messageCount, disputeRead.messageCount) &&
        Objects.equals(this.closedInFavorOf, disputeRead.closedInFavorOf) &&
        Objects.equals(this.disbursedByBuyer, disputeRead.disbursedByBuyer) &&
        Objects.equals(this.maxRefundableForBuyer, disputeRead.maxRefundableForBuyer);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to DisputeRead
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisputeRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisputeRead is not found in the empty JSON string", DisputeRead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisputeRead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisputeRead` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisputeRead.openapiRequiredFields) {
      ...
      if (jsonObj.get("transaction") != null && !jsonObj.get("transaction").isJsonNull()) {
        TransactionRead.validateJsonElement(jsonObj.get("transaction"));
      }
      ...
      for (int i = 0; i < jsonArrayviews.size(); i++) {
        ViewRead.validateJsonElement(jsonArrayviews.get(i));
      };
      // ensure the json data is an array
      ...
      if (jsonObj.get("events") != null && !jsonObj.get("events").isJsonNull()) {
        ...
        if (jsonArrayevents != null) {
          ...
          for (int i = 0; i < jsonArrayevents.size(); i++) {
            WorkflowEventRead.validateJsonElement(jsonArrayevents.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisputeRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisputeRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisputeRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisputeRead.class));

       return (TypeAdapter<T>) new TypeAdapter<DisputeRead>() {
           @Override
           public void write(JsonWriter out, DisputeRead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisputeRead read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DisputeRead given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DisputeRead
  * @throws IOException if the JSON string is invalid with respect to DisputeRead
  */
  public static DisputeRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisputeRead.class);
  }

 /**
  * Convert an instance of DisputeRead to an JSON string
  *
  * @return JSON string
  */
