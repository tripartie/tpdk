...
public class AddressUpdate {
  ...
  public AddressUpdate companyName(String companyName) {
  ...
  **/
  ...
  public AddressUpdate countryCode(String countryCode) {
  ...
  **/
  ...
  public AddressUpdate zipCode(String zipCode) {
  ...
  **/
  ...
  public AddressUpdate cityName(String cityName) {
  ...
  **/
  ...
  public AddressUpdate firstLine(String firstLine) {
  ...
  **/
  ...
  public AddressUpdate secondLine(String secondLine) {
  ...
  **/
  ...
  public AddressUpdate buildingName(String buildingName) {
  ...
  **/
  ...
  public AddressUpdate buildingFloor(String buildingFloor) {
  ...
  **/
  ...
  public AddressUpdate gateOrPortalOrInboxCode(String gateOrPortalOrInboxCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.companyName, addressUpdate.companyName) &&
        Objects.equals(this.countryCode, addressUpdate.countryCode) &&
        Objects.equals(this.zipCode, addressUpdate.zipCode) &&
        Objects.equals(this.cityName, addressUpdate.cityName) &&
        Objects.equals(this.firstLine, addressUpdate.firstLine) &&
        Objects.equals(this.secondLine, addressUpdate.secondLine) &&
        Objects.equals(this.buildingName, addressUpdate.buildingName) &&
        Objects.equals(this.buildingFloor, addressUpdate.buildingFloor) &&
        Objects.equals(this.gateOrPortalOrInboxCode, addressUpdate.gateOrPortalOrInboxCode);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to AddressUpdate
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddressUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddressUpdate is not found in the empty JSON string", AddressUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddressUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddressUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddressUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddressUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddressUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddressUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<AddressUpdate>() {
           @Override
           public void write(JsonWriter out, AddressUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddressUpdate read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AddressUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddressUpdate
  * @throws IOException if the JSON string is invalid with respect to AddressUpdate
  */
  public static AddressUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddressUpdate.class);
  }

 /**
  * Convert an instance of AddressUpdate to an JSON string
  *
  * @return JSON string
  */
