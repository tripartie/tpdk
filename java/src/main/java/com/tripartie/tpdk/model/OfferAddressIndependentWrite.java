...
public class OfferAddressIndependentWrite {
  ...
  public OfferAddressIndependentWrite() {
  }

  public OfferAddressIndependentWrite companyName(String companyName) {
  ...
  **/
  ...
  public OfferAddressIndependentWrite countryCode(String countryCode) {
  ...
  **/
  ...
  public OfferAddressIndependentWrite zipCode(String zipCode) {
  ...
  **/
  ...
  public OfferAddressIndependentWrite cityName(String cityName) {
  ...
  **/
  ...
  public OfferAddressIndependentWrite firstLine(String firstLine) {
  ...
  **/
  ...
  public OfferAddressIndependentWrite secondLine(String secondLine) {
  ...
  **/
  ...
  public OfferAddressIndependentWrite buildingName(String buildingName) {
  ...
  **/
  ...
  public OfferAddressIndependentWrite buildingFloor(String buildingFloor) {
  ...
  **/
  ...
  public OfferAddressIndependentWrite gateOrPortalOrInboxCode(String gateOrPortalOrInboxCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OfferAddressIndependentWrite offerAddressIndependentWrite = (OfferAddressIndependentWrite) o;
    return Objects.equals(this.companyName, offerAddressIndependentWrite.companyName) &&
        Objects.equals(this.countryCode, offerAddressIndependentWrite.countryCode) &&
        Objects.equals(this.zipCode, offerAddressIndependentWrite.zipCode) &&
        Objects.equals(this.cityName, offerAddressIndependentWrite.cityName) &&
        Objects.equals(this.firstLine, offerAddressIndependentWrite.firstLine) &&
        Objects.equals(this.secondLine, offerAddressIndependentWrite.secondLine) &&
        Objects.equals(this.buildingName, offerAddressIndependentWrite.buildingName) &&
        Objects.equals(this.buildingFloor, offerAddressIndependentWrite.buildingFloor) &&
        Objects.equals(this.gateOrPortalOrInboxCode, offerAddressIndependentWrite.gateOrPortalOrInboxCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class OfferAddressIndependentWrite {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to OfferAddressIndependentWrite
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OfferAddressIndependentWrite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OfferAddressIndependentWrite is not found in the empty JSON string", OfferAddressIndependentWrite.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OfferAddressIndependentWrite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OfferAddressIndependentWrite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OfferAddressIndependentWrite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OfferAddressIndependentWrite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OfferAddressIndependentWrite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OfferAddressIndependentWrite.class));

       return (TypeAdapter<T>) new TypeAdapter<OfferAddressIndependentWrite>() {
           @Override
           public void write(JsonWriter out, OfferAddressIndependentWrite value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OfferAddressIndependentWrite read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of OfferAddressIndependentWrite given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OfferAddressIndependentWrite
  * @throws IOException if the JSON string is invalid with respect to OfferAddressIndependentWrite
  */
  public static OfferAddressIndependentWrite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OfferAddressIndependentWrite.class);
  }

 /**
  * Convert an instance of OfferAddressIndependentWrite to an JSON string
  *
  * @return JSON string
  */
