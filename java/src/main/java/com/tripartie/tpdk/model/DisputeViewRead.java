...
public class DisputeViewRead {
  ...
  public DisputeViewRead hitCount(Integer hitCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DisputeViewRead disputeViewRead = (DisputeViewRead) o;
    return Objects.equals(this.hitCount, disputeViewRead.hitCount) &&
        Objects.equals(this.createdAt, disputeViewRead.createdAt) &&
        Objects.equals(this.namedSource, disputeViewRead.namedSource);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisputeViewRead {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to DisputeViewRead
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisputeViewRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisputeViewRead is not found in the empty JSON string", DisputeViewRead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisputeViewRead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisputeViewRead` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisputeViewRead.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisputeViewRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisputeViewRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisputeViewRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisputeViewRead.class));

       return (TypeAdapter<T>) new TypeAdapter<DisputeViewRead>() {
           @Override
           public void write(JsonWriter out, DisputeViewRead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisputeViewRead read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DisputeViewRead given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DisputeViewRead
  * @throws IOException if the JSON string is invalid with respect to DisputeViewRead
  */
  public static DisputeViewRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisputeViewRead.class);
  }

 /**
  * Convert an instance of DisputeViewRead to an JSON string
  *
  * @return JSON string
  */
