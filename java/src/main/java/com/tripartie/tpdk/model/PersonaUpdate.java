...
import com.tripartie.tpdk.model.PersonaUpdateAddress;
...
public class PersonaUpdate {
  ...
  private PersonaUpdateAddress address;
  ...
  **/
  ...
  public PersonaUpdate address(PersonaUpdateAddress address) {
  ...
  **/
  @javax.annotation.Nullable
  public PersonaUpdateAddress getAddress() {
    return address;
  }

  public void setAddress(PersonaUpdateAddress address) {
    this.address = address;
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("address") != null && !jsonObj.get("address").isJsonNull()) {
        PersonaUpdateAddress.validateJsonElement(jsonObj.get("address"));
      }
