...
public class OfferWrite {
  ...
  private List<OfferMetadataWrite> metadata = new ArrayList<>();
  ...
  **/
  ...
  public OfferWrite metadata(List<OfferMetadataWrite> metadata) {
    this.metadata = metadata;
    return this;
  }

  public OfferWrite addMetadataItem(OfferMetadataWrite metadataItem) {
  ...
  **/
  @javax.annotation.Nullable
  public List<OfferMetadataWrite> getMetadata() {
    return metadata;
  }

  public void setMetadata(List<OfferMetadataWrite> metadata) {
    this.metadata = metadata;
  }
      ...
      if (jsonObj.get("metadata") != null && !jsonObj.get("metadata").isJsonNull()) {
        ...
        if (jsonArraymetadata != null) {
          ...
          for (int i = 0; i < jsonArraymetadata.size(); i++) {
            OfferMetadataWrite.validateJsonElement(jsonArraymetadata.get(i));
          };
        }
      }
  }
