...
import com.tripartie.tpdk.model.EvidenceMediaRead;
...
public class EvidenceRead {
  ...
  private EvidenceMediaRead media;
  ...
  **/
  ...
  public EvidenceRead media(EvidenceMediaRead media) {
    this.media = media;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  public EvidenceMediaRead getMedia() {
    return media;
  }

  public void setMedia(EvidenceMediaRead media) {
    this.media = media;
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("media") != null && !jsonObj.get("media").isJsonNull()) {
        EvidenceMediaRead.validateJsonElement(jsonObj.get("media"));
      }
