...
public class EvidenceRead {
  ...
  private EvidenceReadMedia media;
  ...
  **/
  ...
  public EvidenceRead media(EvidenceReadMedia media) {
    this.media = media;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  public EvidenceReadMedia getMedia() {
    return media;
  }

  public void setMedia(EvidenceReadMedia media) {
    this.media = media;
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("media") != null && !jsonObj.get("media").isJsonNull()) {
        EvidenceReadMedia.validateJsonElement(jsonObj.get("media"));
      }
