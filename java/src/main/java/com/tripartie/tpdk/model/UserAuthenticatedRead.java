...
import com.tripartie.tpdk.model.UserAuthenticatedReadOrganization;
...
public class UserAuthenticatedRead {
  ...
  private OrganizationAuthenticatedReadIcon avatar;
  ...
  private UserAuthenticatedReadOrganization organization;
  ...
  **/
  ...
  public UserAuthenticatedRead avatar(OrganizationAuthenticatedReadIcon avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  public OrganizationAuthenticatedReadIcon getAvatar() {
    return avatar;
  }

  public void setAvatar(OrganizationAuthenticatedReadIcon avatar) {
    this.avatar = avatar;
  }
  ...
  **/
  ...
  public UserAuthenticatedRead organization(UserAuthenticatedReadOrganization organization) {
  ...
  **/
  @javax.annotation.Nullable
  public UserAuthenticatedReadOrganization getOrganization() {
    return organization;
  }

  public void setOrganization(UserAuthenticatedReadOrganization organization) {
    this.organization = organization;
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("avatar") != null && !jsonObj.get("avatar").isJsonNull()) {
        OrganizationAuthenticatedReadIcon.validateJsonElement(jsonObj.get("avatar"));
      }
      // validate the optional field `organization`
      if (jsonObj.get("organization") != null && !jsonObj.get("organization").isJsonNull()) {
        UserAuthenticatedReadOrganization.validateJsonElement(jsonObj.get("organization"));
      }
