...
public class DisputeAddressIndependentWrite {
  ...
  public DisputeAddressIndependentWrite() {
  }

  public DisputeAddressIndependentWrite companyName(String companyName) {
  ...
  **/
  ...
  public DisputeAddressIndependentWrite countryCode(String countryCode) {
  ...
  **/
  ...
  public DisputeAddressIndependentWrite zipCode(String zipCode) {
  ...
  **/
  ...
  public DisputeAddressIndependentWrite cityName(String cityName) {
  ...
  **/
  ...
  public DisputeAddressIndependentWrite firstLine(String firstLine) {
  ...
  **/
  ...
  public DisputeAddressIndependentWrite secondLine(String secondLine) {
  ...
  **/
  ...
  public DisputeAddressIndependentWrite buildingName(String buildingName) {
  ...
  **/
  ...
  public DisputeAddressIndependentWrite buildingFloor(String buildingFloor) {
  ...
  **/
  ...
  public DisputeAddressIndependentWrite gateOrPortalOrInboxCode(String gateOrPortalOrInboxCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DisputeAddressIndependentWrite disputeAddressIndependentWrite = (DisputeAddressIndependentWrite) o;
    return Objects.equals(this.companyName, disputeAddressIndependentWrite.companyName) &&
        Objects.equals(this.countryCode, disputeAddressIndependentWrite.countryCode) &&
        Objects.equals(this.zipCode, disputeAddressIndependentWrite.zipCode) &&
        Objects.equals(this.cityName, disputeAddressIndependentWrite.cityName) &&
        Objects.equals(this.firstLine, disputeAddressIndependentWrite.firstLine) &&
        Objects.equals(this.secondLine, disputeAddressIndependentWrite.secondLine) &&
        Objects.equals(this.buildingName, disputeAddressIndependentWrite.buildingName) &&
        Objects.equals(this.buildingFloor, disputeAddressIndependentWrite.buildingFloor) &&
        Objects.equals(this.gateOrPortalOrInboxCode, disputeAddressIndependentWrite.gateOrPortalOrInboxCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisputeAddressIndependentWrite {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to DisputeAddressIndependentWrite
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DisputeAddressIndependentWrite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisputeAddressIndependentWrite is not found in the empty JSON string", DisputeAddressIndependentWrite.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DisputeAddressIndependentWrite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DisputeAddressIndependentWrite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisputeAddressIndependentWrite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisputeAddressIndependentWrite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisputeAddressIndependentWrite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisputeAddressIndependentWrite.class));

       return (TypeAdapter<T>) new TypeAdapter<DisputeAddressIndependentWrite>() {
           @Override
           public void write(JsonWriter out, DisputeAddressIndependentWrite value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DisputeAddressIndependentWrite read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of DisputeAddressIndependentWrite given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DisputeAddressIndependentWrite
  * @throws IOException if the JSON string is invalid with respect to DisputeAddressIndependentWrite
  */
  public static DisputeAddressIndependentWrite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisputeAddressIndependentWrite.class);
  }

 /**
  * Convert an instance of DisputeAddressIndependentWrite to an JSON string
  *
  * @return JSON string
  */
