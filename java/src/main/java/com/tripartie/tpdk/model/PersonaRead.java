...
public class PersonaRead {
  ...
  private PersonaAddressRead address;
  ...
  private List<PersonaMetadataRead> metadata = new ArrayList<>();
  ...
  **/
  ...
  public PersonaRead firstName(String firstName) {
  ...
  **/
  ...
  public PersonaRead lastName(String lastName) {
  ...
  **/
  ...
  public PersonaRead gender(GenderEnum gender) {
    this.gender = gender;
    return this;
  }
  ...
  **/
  ...
  public PersonaRead dateOfBirth(LocalDate dateOfBirth) {
  ...
  **/
  ...
  public PersonaRead language(String language) {
  ...
  **/
  ...
  public PersonaRead email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public PersonaRead mobilePhoneNumber(String mobilePhoneNumber) {
  ...
  **/
  ...
  public PersonaRead address(PersonaAddressRead address) {
  ...
  **/
  @javax.annotation.Nullable
  public PersonaAddressRead getAddress() {
    return address;
  }

  public void setAddress(PersonaAddressRead address) {
    this.address = address;
  }


  public PersonaRead riskLevel(RiskLevelEnum riskLevel) {
  ...
  **/
  ...
  public PersonaRead riskScore(Integer riskScore) {
  ...
  **/
  ...
  public PersonaRead externalPurchaseCount(Integer externalPurchaseCount) {
  ...
  **/
  ...
  public PersonaRead externalSellCount(Integer externalSellCount) {
  ...
  **/
  ...
  public PersonaRead metadata(List<PersonaMetadataRead> metadata) {
    this.metadata = metadata;
    return this;
  }

  public PersonaRead addMetadataItem(PersonaMetadataRead metadataItem) {
  ...
  **/
  @javax.annotation.Nullable
  public List<PersonaMetadataRead> getMetadata() {
    return metadata;
  }

  public void setMetadata(List<PersonaMetadataRead> metadata) {
    this.metadata = metadata;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PersonaRead personaRead = (PersonaRead) o;
    return Objects.equals(this.id, personaRead.id) &&
        Objects.equals(this.firstName, personaRead.firstName) &&
        Objects.equals(this.lastName, personaRead.lastName) &&
        Objects.equals(this.gender, personaRead.gender) &&
        Objects.equals(this.dateOfBirth, personaRead.dateOfBirth) &&
        Objects.equals(this.language, personaRead.language) &&
        Objects.equals(this.email, personaRead.email) &&
        Objects.equals(this.mobilePhoneNumber, personaRead.mobilePhoneNumber) &&
        Objects.equals(this.address, personaRead.address) &&
        Objects.equals(this.riskLevel, personaRead.riskLevel) &&
        Objects.equals(this.riskScore, personaRead.riskScore) &&
        Objects.equals(this.externalPurchaseCount, personaRead.externalPurchaseCount) &&
        Objects.equals(this.externalSellCount, personaRead.externalSellCount) &&
        Objects.equals(this.metadata, personaRead.metadata) &&
        Objects.equals(this.createdAt, personaRead.createdAt) &&
        Objects.equals(this.updatedAt, personaRead.updatedAt) &&
        Objects.equals(this.offerCount, personaRead.offerCount) &&
        Objects.equals(this.purchaseCount, personaRead.purchaseCount);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, firstName, lastName, gender, dateOfBirth, language, email, mobilePhoneNumber, address, riskLevel, riskScore, externalPurchaseCount, externalSellCount, metadata, createdAt, updatedAt, offerCount, purchaseCount);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to PersonaRead
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PersonaRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PersonaRead is not found in the empty JSON string", PersonaRead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PersonaRead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PersonaRead` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("address") != null && !jsonObj.get("address").isJsonNull()) {
        PersonaAddressRead.validateJsonElement(jsonObj.get("address"));
      }
      ...
      if (jsonObj.get("metadata") != null && !jsonObj.get("metadata").isJsonNull()) {
        ...
        if (jsonArraymetadata != null) {
          ...
          for (int i = 0; i < jsonArraymetadata.size(); i++) {
            PersonaMetadataRead.validateJsonElement(jsonArraymetadata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PersonaRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PersonaRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PersonaRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PersonaRead.class));

       return (TypeAdapter<T>) new TypeAdapter<PersonaRead>() {
           @Override
           public void write(JsonWriter out, PersonaRead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PersonaRead read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PersonaRead given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PersonaRead
  * @throws IOException if the JSON string is invalid with respect to PersonaRead
  */
  public static PersonaRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PersonaRead.class);
  }

 /**
  * Convert an instance of PersonaRead to an JSON string
  *
  * @return JSON string
  */
