...
public class UserUserRead {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, firstName, lastName, publicName, roleInCompany, birthday, email, roles, totpEnabled, intlPhoneNumber, originCountry, preferredLanguage, lastSuccessfulLogIn, avatar, createdAt, updatedAt, consentMailNotification, consentMailAds, lockdown, organization, iri, impersonatingOrganization, secondAuthFactor);
  }
