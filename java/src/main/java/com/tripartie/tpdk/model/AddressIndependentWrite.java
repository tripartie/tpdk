...
public class AddressIndependentWrite {
  ...
  public AddressIndependentWrite() {
  }

  public AddressIndependentWrite companyName(String companyName) {
  ...
  **/
  ...
  public AddressIndependentWrite countryCode(String countryCode) {
  ...
  **/
  ...
  public AddressIndependentWrite zipCode(String zipCode) {
  ...
  **/
  ...
  public AddressIndependentWrite cityName(String cityName) {
  ...
  **/
  ...
  public AddressIndependentWrite firstLine(String firstLine) {
  ...
  **/
  ...
  public AddressIndependentWrite secondLine(String secondLine) {
  ...
  **/
  ...
  public AddressIndependentWrite buildingName(String buildingName) {
  ...
  **/
  ...
  public AddressIndependentWrite buildingFloor(String buildingFloor) {
  ...
  **/
  ...
  public AddressIndependentWrite gateOrPortalOrInboxCode(String gateOrPortalOrInboxCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AddressIndependentWrite addressIndependentWrite = (AddressIndependentWrite) o;
    return Objects.equals(this.companyName, addressIndependentWrite.companyName) &&
        Objects.equals(this.countryCode, addressIndependentWrite.countryCode) &&
        Objects.equals(this.zipCode, addressIndependentWrite.zipCode) &&
        Objects.equals(this.cityName, addressIndependentWrite.cityName) &&
        Objects.equals(this.firstLine, addressIndependentWrite.firstLine) &&
        Objects.equals(this.secondLine, addressIndependentWrite.secondLine) &&
        Objects.equals(this.buildingName, addressIndependentWrite.buildingName) &&
        Objects.equals(this.buildingFloor, addressIndependentWrite.buildingFloor) &&
        Objects.equals(this.gateOrPortalOrInboxCode, addressIndependentWrite.gateOrPortalOrInboxCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddressIndependentWrite {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to AddressIndependentWrite
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddressIndependentWrite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddressIndependentWrite is not found in the empty JSON string", AddressIndependentWrite.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddressIndependentWrite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AddressIndependentWrite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddressIndependentWrite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddressIndependentWrite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddressIndependentWrite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddressIndependentWrite.class));

       return (TypeAdapter<T>) new TypeAdapter<AddressIndependentWrite>() {
           @Override
           public void write(JsonWriter out, AddressIndependentWrite value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddressIndependentWrite read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AddressIndependentWrite given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddressIndependentWrite
  * @throws IOException if the JSON string is invalid with respect to AddressIndependentWrite
  */
  public static AddressIndependentWrite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddressIndependentWrite.class);
  }

 /**
  * Convert an instance of AddressIndependentWrite to an JSON string
  *
  * @return JSON string
  */
