...
public class OrganizationAddressUpdate {
  ...
  public OrganizationAddressUpdate() {
  }

  public OrganizationAddressUpdate companyName(String companyName) {
  ...
  **/
  ...
  public OrganizationAddressUpdate countryCode(String countryCode) {
  ...
  **/
  ...
  public OrganizationAddressUpdate zipCode(String zipCode) {
  ...
  **/
  ...
  public OrganizationAddressUpdate cityName(String cityName) {
  ...
  **/
  ...
  public OrganizationAddressUpdate firstLine(String firstLine) {
  ...
  **/
  ...
  public OrganizationAddressUpdate secondLine(String secondLine) {
  ...
  **/
  ...
  public OrganizationAddressUpdate buildingName(String buildingName) {
  ...
  **/
  ...
  public OrganizationAddressUpdate buildingFloor(String buildingFloor) {
  ...
  **/
  ...
  public OrganizationAddressUpdate gateOrPortalOrInboxCode(String gateOrPortalOrInboxCode) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OrganizationAddressUpdate organizationAddressUpdate = (OrganizationAddressUpdate) o;
    return Objects.equals(this.companyName, organizationAddressUpdate.companyName) &&
        Objects.equals(this.countryCode, organizationAddressUpdate.countryCode) &&
        Objects.equals(this.zipCode, organizationAddressUpdate.zipCode) &&
        Objects.equals(this.cityName, organizationAddressUpdate.cityName) &&
        Objects.equals(this.firstLine, organizationAddressUpdate.firstLine) &&
        Objects.equals(this.secondLine, organizationAddressUpdate.secondLine) &&
        Objects.equals(this.buildingName, organizationAddressUpdate.buildingName) &&
        Objects.equals(this.buildingFloor, organizationAddressUpdate.buildingFloor) &&
        Objects.equals(this.gateOrPortalOrInboxCode, organizationAddressUpdate.gateOrPortalOrInboxCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrganizationAddressUpdate {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to OrganizationAddressUpdate
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationAddressUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationAddressUpdate is not found in the empty JSON string", OrganizationAddressUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationAddressUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OrganizationAddressUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationAddressUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationAddressUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationAddressUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationAddressUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationAddressUpdate>() {
           @Override
           public void write(JsonWriter out, OrganizationAddressUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationAddressUpdate read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of OrganizationAddressUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrganizationAddressUpdate
  * @throws IOException if the JSON string is invalid with respect to OrganizationAddressUpdate
  */
  public static OrganizationAddressUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationAddressUpdate.class);
  }

 /**
  * Convert an instance of OrganizationAddressUpdate to an JSON string
  *
  * @return JSON string
  */
