...
public class OrganizationRead {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, vatNumber, commercialRegistryNumber, websiteUrl, customBaseUrl, domainVerified, icon, logo, primaryColor, directNotificationToggle, anonymityLevel, internalMessagingToggle, personaAuthPortalToggle, automatedReturnToggle, counterProposalToggle, flatRateEnabled);
  }
