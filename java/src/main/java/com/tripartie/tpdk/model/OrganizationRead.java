...
public class OrganizationRead {
  ...
  private EvidenceReadMedia icon;

  public static final String SERIALIZED_NAME_LOGO = "logo";
  @SerializedName(SERIALIZED_NAME_LOGO)
  private EvidenceReadMedia logo;
  ...
  **/
  ...
  public OrganizationRead icon(EvidenceReadMedia icon) {
    this.icon = icon;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  public EvidenceReadMedia getIcon() {
    return icon;
  }

  public void setIcon(EvidenceReadMedia icon) {
    this.icon = icon;
  }


  public OrganizationRead logo(EvidenceReadMedia logo) {
    this.logo = logo;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  public EvidenceReadMedia getLogo() {
    return logo;
  }

  public void setLogo(EvidenceReadMedia logo) {
    this.logo = logo;
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("icon") != null && !jsonObj.get("icon").isJsonNull()) {
        EvidenceReadMedia.validateJsonElement(jsonObj.get("icon"));
      }
      // validate the optional field `logo`
      if (jsonObj.get("logo") != null && !jsonObj.get("logo").isJsonNull()) {
        EvidenceReadMedia.validateJsonElement(jsonObj.get("logo"));
      }
