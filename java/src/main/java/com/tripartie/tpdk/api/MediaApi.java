...
public class MediaApi {
    ...
    private okhttp3.Call apiMediasIdGetCall(String id, final ApiCallback _callback) throws ApiException {
    ...
    private ApiResponse<Media> apiMediasIdGetWithHttpInfo(String id) throws ApiException {
    ...
    private okhttp3.Call apiMediasIdGetAsync(String id, final ApiCallback<Media> _callback) throws ApiException {
    ...
    public class APIapiMediasIdGetRequest {
        private final String id;

        private APIapiMediasIdGetRequest(String id) {
            this.id = id;
        }
        ...
        /**
         * Execute apiMediasIdGet request
         * @return Media
        ...
        /**
         * Execute apiMediasIdGet request with HTTP info returned
        ...
        public ApiResponse<Media> executeWithHttpInfo() throws ApiException {
            return apiMediasIdGetWithHttpInfo(id);
        }

        /**
         * Execute apiMediasIdGet request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Media> _callback) throws ApiException {
            return apiMediasIdGetAsync(id, _callback);
        }
    }
     ...
     * @return APIapiMediasIdGetRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Media resource </td><td>  * X-Rate-Limit - HTTP standardized header for rate limit consumption status <br>  </td></tr>
     ...
     */
    public APIapiMediasIdGetRequest apiMediasIdGet(String id) {
        return new APIapiMediasIdGetRequest(id);
    }
}
