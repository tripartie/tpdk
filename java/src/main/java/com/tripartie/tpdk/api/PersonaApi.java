...
public class PersonaApi {
    ...
    private okhttp3.Call apiPersonasGetCollectionCall(Integer page, String firstName, String lastName, String email, List<String> email2, String mobilePhoneNumber, List<String> mobilePhoneNumber2, String gender, String orderCreatedAt, String createdAtBefore, String createdAtStrictlyBefore, String createdAtAfter, String createdAtStrictlyAfter, String dateOfBirthBefore, String dateOfBirthStrictlyBefore, String dateOfBirthAfter, String dateOfBirthStrictlyAfter, List<String> metadata, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call apiPersonasGetCollectionAsync(Integer page, String firstName, String lastName, String email, List<String> email2, String mobilePhoneNumber, List<String> mobilePhoneNumber2, String gender, String orderCreatedAt, String createdAtBefore, String createdAtStrictlyBefore, String createdAtAfter, String createdAtStrictlyAfter, String dateOfBirthBefore, String dateOfBirthStrictlyBefore, String dateOfBirthAfter, String dateOfBirthStrictlyAfter, List<String> metadata, final ApiCallback<List<PersonaCollectionRead>> _callback) throws ApiException {
    ...
    private okhttp3.Call apiPersonasIdtokenPostCall(String id, PersonaTokenWrite personaTokenWrite, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private ApiResponse<PersonaPostAuthRead> apiPersonasIdtokenPostWithHttpInfo(String id, PersonaTokenWrite personaTokenWrite) throws ApiException {
    ...
    private okhttp3.Call apiPersonasIdtokenPostAsync(String id, PersonaTokenWrite personaTokenWrite, final ApiCallback<PersonaPostAuthRead> _callback) throws ApiException {
    ...
    public class APIapiPersonasIdtokenPostRequest {
        private final String id;
        private final PersonaTokenWrite personaTokenWrite;

        private APIapiPersonasIdtokenPostRequest(String id, PersonaTokenWrite personaTokenWrite) {
            this.id = id;
            this.personaTokenWrite = personaTokenWrite;
        }
        ...
        /**
         * Execute apiPersonasIdtokenPost request
         ...
         */
        public PersonaPostAuthRead execute() throws ApiException {
            ApiResponse<PersonaPostAuthRead> localVarResp = apiPersonasIdtokenPostWithHttpInfo(id, personaTokenWrite);
            return localVarResp.getData();
        }

        /**
         * Execute apiPersonasIdtokenPost request with HTTP info returned
         ...
         */
        public ApiResponse<PersonaPostAuthRead> executeWithHttpInfo() throws ApiException {
            return apiPersonasIdtokenPostWithHttpInfo(id, personaTokenWrite);
        }

        /**
         * Execute apiPersonasIdtokenPost request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<PersonaPostAuthRead> _callback) throws ApiException {
            return apiPersonasIdtokenPostAsync(id, personaTokenWrite, _callback);
        }
    }
     ...
     * @return APIapiPersonasIdtokenPostRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Persona resource created </td><td>  * X-Rate-Limit - HTTP standardized header for rate limit consumption status <br>  </td></tr>
     ...
     */
    public APIapiPersonasIdtokenPostRequest apiPersonasIdtokenPost(String id, PersonaTokenWrite personaTokenWrite) {
        return new APIapiPersonasIdtokenPostRequest(id, personaTokenWrite);
    }
