...
public class WebhookApi {
    ...
    private okhttp3.Call apiWebhookSubscriptionsGetCollectionCall(Integer page, String event, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private ApiResponse<List<WebhookSubscriptionRead>> apiWebhookSubscriptionsGetCollectionWithHttpInfo(Integer page, String event) throws ApiException {
    ...
    private okhttp3.Call apiWebhookSubscriptionsGetCollectionAsync(Integer page, String event, final ApiCallback<List<WebhookSubscriptionRead>> _callback) throws ApiException {
    ...
    public class APIapiWebhookSubscriptionsGetCollectionRequest {
        ...
        public ApiResponse<List<WebhookSubscriptionRead>> executeWithHttpInfo() throws ApiException {
            return apiWebhookSubscriptionsGetCollectionWithHttpInfo(page, event);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<WebhookSubscriptionRead>> _callback) throws ApiException {
            return apiWebhookSubscriptionsGetCollectionAsync(page, event, _callback);
        }
    }
