...
public class BrandingApi {
    ...
    private ApiResponse<OrganizationRead> apiOrganizationsIdPatchWithHttpInfo(String id, OrganizationUpdate organizationUpdate) throws ApiException {
    ...
    private okhttp3.Call apiOrganizationsIdPatchAsync(String id, OrganizationUpdate organizationUpdate, final ApiCallback<OrganizationRead> _callback) throws ApiException {
