...
public class ResolutionCenterApi {
    ...
    private ApiResponse<ParcelRead> apiDisputesUlidparcelsPostWithHttpInfo(String ulid, ParcelWrite parcelWrite) throws ApiException {
    ...
    private okhttp3.Call apiDisputesUlidparcelsPostAsync(String ulid, ParcelWrite parcelWrite, final ApiCallback<ParcelRead> _callback) throws ApiException {
    ...
    public class APIapiDisputesUlidparcelsPostRequest {
         ...
         */
        public ParcelRead execute() throws ApiException {
         ...
         */
        public ApiResponse<ParcelRead> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ParcelRead> _callback) throws ApiException {
