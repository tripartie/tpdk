...
public class SafeCheckoutApiTest {
    ...
    public void apiOffersUlidtransactionsGetCollectionTest() throws ApiException {
        ...
        List<String> metadata = null;
        String status = null;
        List<TransactionCollectionRead> response = api.apiOffersUlidtransactionsGetCollection(ulid)
                .page(page)
    ...
    public void apiPersonasIdoffersGetCollectionTest() throws ApiException {
        ...
        String condition = null;
        Boolean shippingAllowed = null;
        List<OfferCollectionRead> response = api.apiPersonasIdoffersGetCollection(id)
                .page(page)
                .title(title)
                .publicUrl(publicUrl)
                .publicUrl2(publicUrl2)
    ...
    public void apiTransactionsUlidparcelsGetCollectionTest() throws ApiException {
        String ulid = null;
        Integer page = null;
        List<Object> response = api.apiTransactionsUlidparcelsGetCollection(ulid)
                .page(page)
                .execute();
        // TODO: test validations
    }
    ...
    public void apiTransactionsUlidparcelsPostTest() throws ApiException {
        ...
        Object response = api.apiTransactionsUlidparcelsPost(ulid, parcelWrite)
                .execute();
        // TODO: test validations
    }
