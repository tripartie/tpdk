 ...
 * 
 * @export
 * @interface PersonaPersonaAuthReturn
 */
export interface PersonaPersonaAuthReturn {
    /**
     * Url that is able to bypass MFA for a single user. Please note that this should not be shared between the complainant and the seller or anyone external to them.
     * @type {string}
     * @memberof PersonaPersonaAuthReturn
     */
    'authUrl'?: string | null;
    /**
     * This authenticated-URL cannot be renewed, you will have to re-create one each time. Typically valid for a single hour.
 ...
 * 
 * @export
 * @interface PersonaPersonaExternalAuth
 */
export interface PersonaPersonaExternalAuth {
    /**
     * 
     * @type {string}
     * @memberof PersonaPersonaExternalAuth
     */
    'captcha'?: string | null;
    /**
     * The URL you wish that Persona to go to without additional MFA. The URL MUST concern that Persona.
...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {PersonaPersonaExternalAuth} personaPersonaExternalAuth The new Persona resource
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiPersonasauthenticationPost: async (personaPersonaExternalAuth: PersonaPersonaExternalAuth, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'personaPersonaExternalAuth' is not null or undefined
            assertParamExists('apiPersonasauthenticationPost', 'personaPersonaExternalAuth', personaPersonaExternalAuth)
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(personaPersonaExternalAuth, localVarRequestOptions, configuration)
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiPersonasauthenticationPost(personaPersonaExternalAuth: PersonaPersonaExternalAuth, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PersonaPersonaAuthReturn>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiPersonasauthenticationPost(personaPersonaExternalAuth, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Creates a Persona resource.
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiPersonasauthenticationPost(personaPersonaExternalAuth: PersonaPersonaExternalAuth, options?: any): AxiosPromise<PersonaPersonaAuthReturn> {
            return localVarFp.apiPersonasauthenticationPost(personaPersonaExternalAuth, options).then((request) => request(axios, basePath));
        },
        /**
         * Creates a Persona resource.
         * @summary Persona external registration
...
export class UserApi extends BaseAPI {
     ...
     * @memberof UserApi
     */
    public apiPersonasauthenticationPost(personaPersonaExternalAuth: PersonaPersonaExternalAuth, options?: AxiosRequestConfig) {
        return UserApiFp(this.configuration).apiPersonasauthenticationPost(personaPersonaExternalAuth, options).then((request) => request(this.axios, this.basePath));
    }
