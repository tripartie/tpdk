 ...
 * 
 * @export
 * @interface AuthenticationPost200Response
 */
export interface AuthenticationPost200Response {
    /**
     * 
     * @type {string}
     * @memberof AuthenticationPost200Response
     */
    'token'?: string;
}
/**
...
export const MediaApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async apiMediasIdGet(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Media>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['MediaApi.apiMediasIdGet']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {AuthenticationPostRequest} [authenticationPostRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        authenticationPost: async (authenticationPostRequest?: AuthenticationPostRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(authenticationPostRequest, localVarRequestOptions, configuration)
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async apiUsersIdpasswordPatch(id: string, userUserPasswordUpdate: UserUserPasswordUpdate, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserUserRead>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['UserApi.apiUsersIdpasswordPatch']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Updates the User resource.
        ...
        async apiUsersIdtotpSetupPatch(id: string, body: object, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserTotpSetupRead>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['UserApi.apiUsersIdtotpSetupPatch']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Updates the User resource.
        ...
        async apiUsersIdtotpTogglePatch(id: string, userTotpToggleWrite: UserTotpToggleWrite, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['UserApi.apiUsersIdtotpTogglePatch']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * This endpoint is protected by a captcha, do not try to use it to consume our API. IP/CIDR to be banned upon fraudulent/irregular usage. Follow the oauth 2.0 authentication challenge as described in the documentation.
         ...
         * @throws {RequiredError}
         */
        async authenticationPost(authenticationPostRequest?: AuthenticationPostRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthenticationPost200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.authenticationPost(authenticationPostRequest, options);
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['UserApi.authenticationPost']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        authenticationPost(authenticationPostRequest?: AuthenticationPostRequest, options?: any): AxiosPromise<AuthenticationPost200Response> {
            return localVarFp.authenticationPost(authenticationPostRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class UserApi extends BaseAPI {
     ...
     * @memberof UserApi
     */
    public authenticationPost(authenticationPostRequest?: AuthenticationPostRequest, options?: RawAxiosRequestConfig) {
        return UserApiFp(this.configuration).authenticationPost(authenticationPostRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
