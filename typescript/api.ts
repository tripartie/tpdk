...
export const ResolutionCenterApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiDisputesUlidparcelsGet: async (ulid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ulid' is not null or undefined
            assertParamExists('apiDisputesUlidparcelsGet', 'ulid', ulid)
...
export const ResolutionCenterApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiDisputesUlidparcelsGet(ulid: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ParcelRead>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiDisputesUlidparcelsGet(ulid, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Removes the Parcel resource.
...
export const ResolutionCenterApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiDisputesUlidparcelsGet(ulid: string, options?: any): AxiosPromise<ParcelRead> {
            return localVarFp.apiDisputesUlidparcelsGet(ulid, options).then((request) => request(axios, basePath));
        },
        /**
         * Removes the Parcel resource.
         * @summary Removes the Parcel resource.
...
export class ResolutionCenterApi extends BaseAPI {
     ...
     * @memberof ResolutionCenterApi
     */
    public apiDisputesUlidparcelsGet(ulid: string, options?: AxiosRequestConfig) {
        return ResolutionCenterApiFp(this.configuration).apiDisputesUlidparcelsGet(ulid, options).then((request) => request(this.axios, this.basePath));
    }
