...
export interface Dispute {
     ...
     * @memberof Dispute
     */
    'awaitedParty'?: DisputeAwaitedPartyEnum;
    /**
     * 
     * @type {string}
     * @memberof Dispute
...
/**
    ...
    * @enum {string}
    */
export enum DisputeAwaitedPartyEnum {
    Buyer = 'BUYER',
    Platform = 'PLATFORM',
    Seller = 'SELLER'
}
...
export interface OfferRead {
    ...
    /**
     * 
     * @type {OfferReadOrganization}
     * @memberof OfferRead
     */
    'organization'?: OfferReadOrganization | null;
    /**
     * If the seller is actually YOUR organization, set it to NULL.
     * @type {string}
     * @memberof OfferRead
 ...
 * 
 * @export
 * @interface OfferReadOrganization
 */
export interface OfferReadOrganization {
    /**
     * 
     * @type {string}
     * @memberof OfferReadOrganization
     */
    'name'?: string;
    /**
     * 
     ...
     * @memberof OfferReadOrganization
     */
    'icon'?: EvidenceReadMedia | null;
    /**
     * 
     * @type {EvidenceReadMedia}
     * @memberof OfferReadOrganization
     */
    'logo'?: EvidenceReadMedia | null;
    /**
     * 
     * @type {string}
     * @memberof OfferReadOrganization
...
export interface OrganizationAuthenticatedRead {
    ...
    /**
     * 
     * @type {OrganizationAuthenticatedReadIcon}
     * @memberof OrganizationAuthenticatedRead
     */
    'icon'?: OrganizationAuthenticatedReadIcon | null;
    /**
     * 
     * @type {OrganizationAuthenticatedReadIcon}
     * @memberof OrganizationAuthenticatedRead
     */
    'logo'?: OrganizationAuthenticatedReadIcon | null;
    /**
     * 
     * @type {boolean}
     * @memberof OrganizationAuthenticatedRead
 ...
 * 
 * @export
 * @interface OrganizationAuthenticatedReadIcon
 */
export interface OrganizationAuthenticatedReadIcon {
    /**
     * 
     * @type {string}
     * @memberof OrganizationAuthenticatedReadIcon
     */
    'publicUrl': string;
}
/**
...
export interface OrganizationCollectionRead {
    ...
    /**
     * 
     * @type {OrganizationCollectionReadIcon}
     * @memberof OrganizationCollectionRead
     */
    'icon'?: OrganizationCollectionReadIcon | null;
    /**
     * 
     * @type {OrganizationCollectionReadIcon}
     * @memberof OrganizationCollectionRead
     */
    'logo'?: OrganizationCollectionReadIcon | null;
    /**
     * 
     * @type {boolean}
     * @memberof OrganizationCollectionRead
 ...
 * 
 * @export
 * @interface OrganizationCollectionReadIcon
 */
export interface OrganizationCollectionReadIcon {
    /**
     * 
     * @type {string}
     * @memberof OrganizationCollectionReadIcon
     */
    'publicUrl': string;
}
/**
...
export interface UserAuthenticatedRead {
     ...
     * @memberof UserAuthenticatedRead
     */
    'avatar'?: OrganizationAuthenticatedReadIcon | null;
    /**
     * 
     * @type {string}
     * @memberof UserAuthenticatedRead
    ...
    /**
     * 
     * @type {UserAuthenticatedReadOrganization}
     * @memberof UserAuthenticatedRead
     */
    'organization'?: UserAuthenticatedReadOrganization | null;
}
 ...
 * 
 * @export
 * @interface UserAuthenticatedReadOrganization
 */
export interface UserAuthenticatedReadOrganization {
    /**
     * 
     * @type {number}
     * @memberof UserAuthenticatedReadOrganization
     */
    'id'?: number;
    /**
     * 
...
export interface UserCollectionRead {
     ...
     * @memberof UserCollectionRead
     */
    'avatar'?: OrganizationCollectionReadIcon | null;
    /**
     * 
     * @type {string}
     * @memberof UserCollectionRead
    ...
    /**
     * 
     * @type {UserCollectionReadOrganization}
     * @memberof UserCollectionRead
     */
    'organization'?: UserCollectionReadOrganization | null;
}
 ...
 * 
 * @export
 * @interface UserCollectionReadOrganization
 */
export interface UserCollectionReadOrganization {
    /**
     * 
     * @type {number}
     * @memberof UserCollectionReadOrganization
     */
    'id'?: number;
    /**
     * 
...
/**
    ...
    * @enum {string}
    */
export enum WorkflowEventEventEnum {
    DisputeOpened = 'dispute.opened',
    DisputeSubmitted = 'dispute.submitted',
    DisputeCreated = 'dispute.created',
    DisputeAbandoned = 'dispute.abandoned',
...
export const ResolutionCenterApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [createdAtAfter] 
         * @param {string} [createdAtStrictlyAfter] 
         * @param {'CREATED' | 'SUBMITTED' | 'OPENED' | 'ABANDONED' | 'OBJECTED' | 'PENDING_SHIPMENT' | 'SHIPPED' | 'IN_TRANSIT' | 'RETURNED' | 'DISMISSED' | 'RESOLVED' | 'PENDING'} [status] Filter on a limited subset of status
         ...
         * @throws {RequiredError}
         */
        apiDisputesGetCollection: async (page?: number, orderCreatedAt?: 'asc' | 'desc', orderStatus?: 'asc' | 'desc', orderUpdatedAt?: 'asc' | 'desc', transactionOfferTitle?: string, createdAtBefore?: string, createdAtStrictlyBefore?: string, createdAtAfter?: string, createdAtStrictlyAfter?: string, status?: 'CREATED' | 'SUBMITTED' | 'OPENED' | 'ABANDONED' | 'OBJECTED' | 'PENDING_SHIPMENT' | 'SHIPPED' | 'IN_TRANSIT' | 'RETURNED' | 'DISMISSED' | 'RESOLVED' | 'PENDING', transactionStatus?: 'CREATED' | 'AUTHORIZED' | 'REFUSED' | 'ACCEPTED' | 'SHIPPED' | 'IN_TRANSIT' | 'DELIVERED' | 'COMPLETED' | 'DISPUTED', existsRecommendedSolution?: boolean, existsChosenSolution?: boolean, existsCounterSolution?: boolean, existsPlatformSolution?: boolean, metadata?: Array<string>, transactionMetadata?: Array<string>, transactionOfferMetadata?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @summary Read single parcel state
         * @param {string} ulid 
         * @param {number} id 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiDisputesUlidparcelsIdGet: async (ulid: string, id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ulid' is not null or undefined
            assertParamExists('apiDisputesUlidparcelsIdGet', 'ulid', ulid)
            // verify required parameter 'id' is not null or undefined
            assertParamExists('apiDisputesUlidparcelsIdGet', 'id', id)
            const localVarPath = `/disputes/{ulid}/parcels/{id}`
                .replace(`{${"ulid"}}`, encodeURIComponent(String(ulid)))
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const ResolutionCenterApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiDisputesUlidparcelsIdGet(ulid: string, id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ParcelRead>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiDisputesUlidparcelsIdGet(ulid, id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Creates a Parcel resource.
...
export const ResolutionCenterApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiDisputesUlidparcelsIdGet(ulid: string, id: number, options?: any): AxiosPromise<ParcelRead> {
            return localVarFp.apiDisputesUlidparcelsIdGet(ulid, id, options).then((request) => request(axios, basePath));
        },
        /**
         * Creates a Parcel resource.
         * @summary Creates a Parcel resource.
...
export class ResolutionCenterApi extends BaseAPI {
     ...
     * @memberof ResolutionCenterApi
     */
    public apiDisputesUlidparcelsIdGet(ulid: string, id: number, options?: AxiosRequestConfig) {
        return ResolutionCenterApiFp(this.configuration).apiDisputesUlidparcelsIdGet(ulid, id, options).then((request) => request(this.axios, this.basePath));
    }
...
export const SafeCheckoutApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiOffersUlidtransactionsGetCollection: async (ulid: string, page?: number, orderStatus?: 'asc' | 'desc', metadata?: Array<string>, status?: 'CREATED' | 'AUTHORIZED' | 'REFUSED' | 'ACCEPTED' | 'SHIPPED' | 'IN_TRANSIT' | 'DELIVERED' | 'COMPLETED' | 'DISPUTED', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ulid' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        apiTransactionsGetCollection: async (page?: number, orderStatus?: 'asc' | 'desc', metadata?: Array<string>, status?: 'CREATED' | 'AUTHORIZED' | 'REFUSED' | 'ACCEPTED' | 'SHIPPED' | 'IN_TRANSIT' | 'DELIVERED' | 'COMPLETED' | 'DISPUTED', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        apiTransactionsUlidparcelsGet: async (ulid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'ulid' is not null or undefined
            assertParamExists('apiTransactionsUlidparcelsGet', 'ulid', ulid)
...
export const SafeCheckoutApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiOffersUlidtransactionsGetCollection(ulid: string, page?: number, orderStatus?: 'asc' | 'desc', metadata?: Array<string>, status?: 'CREATED' | 'AUTHORIZED' | 'REFUSED' | 'ACCEPTED' | 'SHIPPED' | 'IN_TRANSIT' | 'DELIVERED' | 'COMPLETED' | 'DISPUTED', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TransactionCollectionRead>>> {
         ...
         * @throws {RequiredError}
         */
        async apiTransactionsGetCollection(page?: number, orderStatus?: 'asc' | 'desc', metadata?: Array<string>, status?: 'CREATED' | 'AUTHORIZED' | 'REFUSED' | 'ACCEPTED' | 'SHIPPED' | 'IN_TRANSIT' | 'DELIVERED' | 'COMPLETED' | 'DISPUTED', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TransactionCollectionRead>>> {
         ...
         * @throws {RequiredError}
         */
        async apiTransactionsUlidparcelsGet(ulid: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ParcelRead>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiTransactionsUlidparcelsGet(ulid, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * No one except the support can do that manoeuvre.
...
export const SafeCheckoutApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiOffersUlidtransactionsGetCollection(ulid: string, page?: number, orderStatus?: 'asc' | 'desc', metadata?: Array<string>, status?: 'CREATED' | 'AUTHORIZED' | 'REFUSED' | 'ACCEPTED' | 'SHIPPED' | 'IN_TRANSIT' | 'DELIVERED' | 'COMPLETED' | 'DISPUTED', options?: any): AxiosPromise<Array<TransactionCollectionRead>> {
         ...
         * @throws {RequiredError}
         */
        apiTransactionsGetCollection(page?: number, orderStatus?: 'asc' | 'desc', metadata?: Array<string>, status?: 'CREATED' | 'AUTHORIZED' | 'REFUSED' | 'ACCEPTED' | 'SHIPPED' | 'IN_TRANSIT' | 'DELIVERED' | 'COMPLETED' | 'DISPUTED', options?: any): AxiosPromise<Array<TransactionCollectionRead>> {
         ...
         * @throws {RequiredError}
         */
        apiTransactionsUlidparcelsGet(ulid: string, options?: any): AxiosPromise<ParcelRead> {
            return localVarFp.apiTransactionsUlidparcelsGet(ulid, options).then((request) => request(axios, basePath));
        },
        /**
         * No one except the support can do that manoeuvre.
         * @summary Withdraw shipment from Transaction
...
export class SafeCheckoutApi extends BaseAPI {
     ...
     * @memberof SafeCheckoutApi
     */
    public apiOffersUlidtransactionsGetCollection(ulid: string, page?: number, orderStatus?: 'asc' | 'desc', metadata?: Array<string>, status?: 'CREATED' | 'AUTHORIZED' | 'REFUSED' | 'ACCEPTED' | 'SHIPPED' | 'IN_TRANSIT' | 'DELIVERED' | 'COMPLETED' | 'DISPUTED', options?: AxiosRequestConfig) {
     ...
     * @memberof SafeCheckoutApi
     */
    public apiTransactionsGetCollection(page?: number, orderStatus?: 'asc' | 'desc', metadata?: Array<string>, status?: 'CREATED' | 'AUTHORIZED' | 'REFUSED' | 'ACCEPTED' | 'SHIPPED' | 'IN_TRANSIT' | 'DELIVERED' | 'COMPLETED' | 'DISPUTED', options?: AxiosRequestConfig) {
     ...
     * @memberof SafeCheckoutApi
     */
    public apiTransactionsUlidparcelsGet(ulid: string, options?: AxiosRequestConfig) {
        return SafeCheckoutApiFp(this.configuration).apiTransactionsUlidparcelsGet(ulid, options).then((request) => request(this.axios, this.basePath));
    }
