...
export interface WebhookObject {
     ...
     * @memberof WebhookObject
     */
    'recommendedPartialRefundAmount'?: number;
    /**
     * 
     * @type {string}
     * @memberof WebhookObject
     ...
     * @memberof WebhookObject
     */
    'chosenPartialRefundAmount'?: number;
    /**
     * 
     * @type {string}
     * @memberof WebhookObject
     ...
     * @memberof WebhookObject
     */
    'counterPartialRefundAmount'?: number;
    /**
     * 
     * @type {string}
     * @memberof WebhookObject
     ...
     * @memberof WebhookObject
     */
    'platformPartialRefundAmount'?: number;
    /**
     * 
     * @type {boolean}
     * @memberof WebhookObject
     ...
     * @memberof WebhookObject
     */
    'disbursedByBuyer'?: number;
    /**
     * How much the buyer can actually receive back in case of a full refund.
     * @type {number}
     * @memberof WebhookObject
     */
    'maxRefundableForBuyer'?: number;
    /**
     * 
     * @type {number}
     * @memberof WebhookObject
...
export const EvidenceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary Retrieves a Evidence resource.
         * @param {string} id Evidence identifier
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiEvidencesIdGet: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('apiEvidencesIdGet', 'id', id)
            const localVarPath = `/evidences/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const EvidenceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiEvidencesIdGet(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Evidence>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiEvidencesIdGet(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['EvidenceApi.apiEvidencesIdGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const EvidenceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiEvidencesIdGet(id: string, options?: any): AxiosPromise<Evidence> {
            return localVarFp.apiEvidencesIdGet(id, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class EvidenceApi extends BaseAPI {
     ...
     */
    public apiEvidencesIdGet(id: string, options?: RawAxiosRequestConfig) {
        return EvidenceApiFp(this.configuration).apiEvidencesIdGet(id, options).then((request) => request(this.axios, this.basePath));
    }
}
