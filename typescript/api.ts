...
export interface OrganizationUpdate {
     ...
     * @memberof OrganizationUpdate
     */
    'endUserNotificationToggle': boolean;
    /**
     * 
     * @type {string}
     * @memberof OrganizationUpdate
...
export const BrandingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiOrganizationsIdiconDelete: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            await setApiKeyToObject(localVarHeaderParameter, "X-Persona-Auth", configuration)
...
export const PersonaApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiPersonasGetCollection: async (page?: number, firstName?: string, lastName?: string, dateOfBirth?: string, dateOfBirth2?: string, email?: string, mobilePhoneNumber?: string, mobilePhoneNumber2?: Array<string>, gender?: 'MALE' | 'FEMALE' | 'OTHER' | 'RATHER_NOT_SAY', orderCreatedAt?: 'asc' | 'desc', createdAtBefore?: string, createdAtStrictlyBefore?: string, createdAtAfter?: string, createdAtStrictlyAfter?: string, metadata?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            if (dateOfBirth2 !== undefined) {
                localVarQueryParameter['dateOfBirth[]'] = dateOfBirth2;
            }
         ...
         * @throws {RequiredError}
         */
        apiPersonasIdtokenPost: async (id: string, personaWrite: PersonaWrite, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('apiPersonasIdtokenPost', 'id', id)
            // verify required parameter 'personaWrite' is not null or undefined
            assertParamExists('apiPersonasIdtokenPost', 'personaWrite', personaWrite)
...
export const PersonaApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiPersonasGetCollection(page?: number, firstName?: string, lastName?: string, dateOfBirth?: string, dateOfBirth2?: string, email?: string, mobilePhoneNumber?: string, mobilePhoneNumber2?: Array<string>, gender?: 'MALE' | 'FEMALE' | 'OTHER' | 'RATHER_NOT_SAY', orderCreatedAt?: 'asc' | 'desc', createdAtBefore?: string, createdAtStrictlyBefore?: string, createdAtAfter?: string, createdAtStrictlyAfter?: string, metadata?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PersonaCollectionRead>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiPersonasGetCollection(page, firstName, lastName, dateOfBirth, dateOfBirth2, email, mobilePhoneNumber, mobilePhoneNumber2, gender, orderCreatedAt, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, metadata, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * You **MAY** unregister (or free the email/phone number) your Persona entry using that endpoint. *Please note that* this operation will fail if that Persona have any ongoing operations.
         ...
         * @throws {RequiredError}
         */
        async apiPersonasIdtokenPost(id: string, personaWrite: PersonaWrite, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PersonaPostAuthRead>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiPersonasIdtokenPost(id, personaWrite, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * You should not register your whole database of users, only those who are concerned by a Safe-checkout or Dispute operation. One Persona entry for your organization can be assigned as a seller or buyer.  **Notes:**   - (i) There is a unique constraint for the mobile phone numbers and email.   - (ii) You will have to issue a DELETE operation on a Persona that withhold a specific phone number or email.   - (iii) You are NOT REQUIRED to provide email OR a mobile phone number but it is highly recommended, if none provided the email will be generated as \'{ulid}@your-domain.tld\'. In that case, please specify at least one metadata in order to find your entry with ease.
...
export const PersonaApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiPersonasGetCollection(page?: number, firstName?: string, lastName?: string, dateOfBirth?: string, dateOfBirth2?: string, email?: string, mobilePhoneNumber?: string, mobilePhoneNumber2?: Array<string>, gender?: 'MALE' | 'FEMALE' | 'OTHER' | 'RATHER_NOT_SAY', orderCreatedAt?: 'asc' | 'desc', createdAtBefore?: string, createdAtStrictlyBefore?: string, createdAtAfter?: string, createdAtStrictlyAfter?: string, metadata?: Array<string>, options?: any): AxiosPromise<Array<PersonaCollectionRead>> {
            return localVarFp.apiPersonasGetCollection(page, firstName, lastName, dateOfBirth, dateOfBirth2, email, mobilePhoneNumber, mobilePhoneNumber2, gender, orderCreatedAt, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, metadata, options).then((request) => request(axios, basePath));
        },
        /**
         * You **MAY** unregister (or free the email/phone number) your Persona entry using that endpoint. *Please note that* this operation will fail if that Persona have any ongoing operations.
         * @summary Unregister a Persona (Your customer)
         ...
         * @throws {RequiredError}
         */
        apiPersonasIdtokenPost(id: string, personaWrite: PersonaWrite, options?: any): AxiosPromise<PersonaPostAuthRead> {
            return localVarFp.apiPersonasIdtokenPost(id, personaWrite, options).then((request) => request(axios, basePath));
        },
        /**
         * You should not register your whole database of users, only those who are concerned by a Safe-checkout or Dispute operation. One Persona entry for your organization can be assigned as a seller or buyer.  **Notes:**   - (i) There is a unique constraint for the mobile phone numbers and email.   - (ii) You will have to issue a DELETE operation on a Persona that withhold a specific phone number or email.   - (iii) You are NOT REQUIRED to provide email OR a mobile phone number but it is highly recommended, if none provided the email will be generated as \'{ulid}@your-domain.tld\'. In that case, please specify at least one metadata in order to find your entry with ease.
         * @summary Register a Persona (Your customer)
...
export class PersonaApi extends BaseAPI {
     ...
     * @memberof PersonaApi
     */
    public apiPersonasGetCollection(page?: number, firstName?: string, lastName?: string, dateOfBirth?: string, dateOfBirth2?: string, email?: string, mobilePhoneNumber?: string, mobilePhoneNumber2?: Array<string>, gender?: 'MALE' | 'FEMALE' | 'OTHER' | 'RATHER_NOT_SAY', orderCreatedAt?: 'asc' | 'desc', createdAtBefore?: string, createdAtStrictlyBefore?: string, createdAtAfter?: string, createdAtStrictlyAfter?: string, metadata?: Array<string>, options?: AxiosRequestConfig) {
        return PersonaApiFp(this.configuration).apiPersonasGetCollection(page, firstName, lastName, dateOfBirth, dateOfBirth2, email, mobilePhoneNumber, mobilePhoneNumber2, gender, orderCreatedAt, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, metadata, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PersonaApi
     */
    public apiPersonasIdtokenPost(id: string, personaWrite: PersonaWrite, options?: AxiosRequestConfig) {
        return PersonaApiFp(this.configuration).apiPersonasIdtokenPost(id, personaWrite, options).then((request) => request(this.axios, this.basePath));
    }
...
export class TransactionApi extends BaseAPI {
    ...
    public apiTransactionsGetCollection(page?: number, orderStatus?: 'asc' | 'desc', metadata?: Array<string>, status?: 'CREATED' | 'AUTHORIZED' | 'REFUSED' | 'ACCEPTED' | 'SHIPPED' | 'IN_TRANSIT' | 'DELIVERED' | 'COMPLETED' | 'DISPUTED', existsDispute?: boolean, options?: AxiosRequestConfig) {
        return TransactionApiFp(this.configuration).apiTransactionsGetCollection(page, orderStatus, metadata, status, existsDispute, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {Persona} persona The new Persona resource
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiPersonasauthenticationPost: async (persona: Persona, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'persona' is not null or undefined
            assertParamExists('apiPersonasauthenticationPost', 'persona', persona)
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiPersonasauthenticationPost(persona: Persona, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Persona>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiPersonasauthenticationPost(persona, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Creates a Persona resource.
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiPersonasauthenticationPost(persona: Persona, options?: any): AxiosPromise<Persona> {
            return localVarFp.apiPersonasauthenticationPost(persona, options).then((request) => request(axios, basePath));
        },
        /**
         * Creates a Persona resource.
         * @summary Persona external registration
...
export class UserApi extends BaseAPI {
     ...
     */
    public apiOrganizationsIdPatch(id: string, organizationUpdate: OrganizationUpdate, options?: AxiosRequestConfig) {
        return UserApiFp(this.configuration).apiOrganizationsIdPatch(id, organizationUpdate, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof UserApi
     */
    public apiPersonasauthenticationPost(persona: Persona, options?: AxiosRequestConfig) {
        return UserApiFp(this.configuration).apiPersonasauthenticationPost(persona, options).then((request) => request(this.axios, this.basePath));
    }
...
export const WebhookApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} [page] The collection page number
         * @param {'dispute.opened' | 'dispute.submitted' | 'dispute.created' | 'dispute.abandoned' | 'dispute.settlement' | 'dispute.closed' | 'dispute.manual_arbitration_required' | 'dispute.updated' | 'offer.created' | 'offer.expired' | 'offer.updated' | 'offer.crawl_failure' | 'offer.transaction.authorized' | 'offer.transaction.reconciled' | 'offer.transaction.abandoned' | 'offer.closed' | 'offer.transaction.refund' | 'persona.added'} [event] Filter on a limited subset of event
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiWebhookSubscriptionsGetCollection: async (page?: number, event?: 'dispute.opened' | 'dispute.submitted' | 'dispute.created' | 'dispute.abandoned' | 'dispute.settlement' | 'dispute.closed' | 'dispute.manual_arbitration_required' | 'dispute.updated' | 'offer.created' | 'offer.expired' | 'offer.updated' | 'offer.crawl_failure' | 'offer.transaction.authorized' | 'offer.transaction.reconciled' | 'offer.transaction.abandoned' | 'offer.closed' | 'offer.transaction.refund' | 'persona.added', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const WebhookApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiWebhookSubscriptionsGetCollection(page?: number, event?: 'dispute.opened' | 'dispute.submitted' | 'dispute.created' | 'dispute.abandoned' | 'dispute.settlement' | 'dispute.closed' | 'dispute.manual_arbitration_required' | 'dispute.updated' | 'offer.created' | 'offer.expired' | 'offer.updated' | 'offer.crawl_failure' | 'offer.transaction.authorized' | 'offer.transaction.reconciled' | 'offer.transaction.abandoned' | 'offer.closed' | 'offer.transaction.refund' | 'persona.added', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<WebhookSubscriptionRead>>> {
...
export const WebhookApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiWebhookSubscriptionsGetCollection(page?: number, event?: 'dispute.opened' | 'dispute.submitted' | 'dispute.created' | 'dispute.abandoned' | 'dispute.settlement' | 'dispute.closed' | 'dispute.manual_arbitration_required' | 'dispute.updated' | 'offer.created' | 'offer.expired' | 'offer.updated' | 'offer.crawl_failure' | 'offer.transaction.authorized' | 'offer.transaction.reconciled' | 'offer.transaction.abandoned' | 'offer.closed' | 'offer.transaction.refund' | 'persona.added', options?: any): AxiosPromise<Array<WebhookSubscriptionRead>> {
...
export class WebhookApi extends BaseAPI {
     ...
     * @memberof WebhookApi
     */
    public apiWebhookSubscriptionsGetCollection(page?: number, event?: 'dispute.opened' | 'dispute.submitted' | 'dispute.created' | 'dispute.abandoned' | 'dispute.settlement' | 'dispute.closed' | 'dispute.manual_arbitration_required' | 'dispute.updated' | 'offer.created' | 'offer.expired' | 'offer.updated' | 'offer.crawl_failure' | 'offer.transaction.authorized' | 'offer.transaction.reconciled' | 'offer.transaction.abandoned' | 'offer.closed' | 'offer.transaction.refund' | 'persona.added', options?: AxiosRequestConfig) {
